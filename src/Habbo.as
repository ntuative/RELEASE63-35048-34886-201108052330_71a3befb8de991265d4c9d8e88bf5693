package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static function method_1(param1:String, param2:int, param3:Error) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            method_1("Failed to finalize main swf preloading: " + error.message,const_9,error);
         }
      }
      ...
      {
         trackLoginStep(const_7);
         method_1("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_8,const_9,null);
      }
