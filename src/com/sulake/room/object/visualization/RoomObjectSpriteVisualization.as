package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_401:IRoomObject;
      
      private var var_809:IGraphicAssetCollection;
      
      protected var var_520:int = -1;
      
      protected var var_145:int = -1;
      
      protected var var_101:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_217 != null)
         {
            ...
            {
               _loc1_ = this.var_217[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_809.removeReference();
         }
         this.var_809 = param1;
         if(this.var_809 != null)
         {
            this.var_809.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_217.length > param1)
         {
            _loc2_ = this.var_217[this.var_217.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         this.var_520 = 4294967295;
         this.var_145 = 4294967295;
         this.var_101 = -1;
      }
