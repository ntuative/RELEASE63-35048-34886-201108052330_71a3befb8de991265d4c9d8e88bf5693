package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_538:Number = 64;
      
      public static const const_1231:Number = 32;
      ...
      private var var_180:Vector3d;
      
      private var var_181:Vector3d;
      
      private var var_1357:Vector3d;
      
      private var var_487:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1356:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_483:Number = 1.0;
      
      private var var_486:Number = 1.0;
      
      private var var_484:Number = 1.0;
      ...
      private var var_3126:Number = -500.0;
      
      private var var_3125:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1357 = new Vector3d();
         this.var_487 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1356 = new Vector3d();
         this.var_2103 = 1;
         this.var_2102 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2101 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_487.assign(this.var_105);
         this.var_487.x *= this.var_483;
         this.var_487.y *= this.var_486;
         this.var_487.z *= this.var_484;
         return this.var_487;
      }
      ...
      {
         if(this.var_483 != param1 * this.var_2103)
         {
            this.var_483 = param1 * this.var_2103;
            ++this.var_183;
         }
      }
      ...
      {
         if(this.var_486 != param1 * this.var_2102)
         {
            this.var_486 = param1 * this.var_2102;
            ++this.var_183;
         }
      }
      ...
      {
         if(this.var_484 != param1 * this.var_2101)
         {
            this.var_484 = param1 * this.var_2101;
            ++this.var_183;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_483;
         this.var_105.y /= this.var_486;
         this.var_105.z /= this.var_484;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_485.x;
         var _loc3_:Number = this.var_485.y;
         var _loc4_:Number = this.var_485.z;
         this.var_485.assign(param1);
         this._direction.assign(param1);
         if(this.var_485.x != _loc2_ || this.var_485.y != _loc3_ || this.var_485.z != _loc4_)
         {
            ++this.var_183;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_180.assign(_loc24_);
            this.var_181.assign(_loc25_);
            this.var_1357.assign(this.var_181);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_180.assign(_loc19_);
            this.var_181.assign(_loc20_);
            this.var_1357.assign(this.var_181);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_588 != null)
         {
            ...
            this.var_588.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_588.add(_loc3_,_loc4_);
            ++this.var_183;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_588 != null)
         {
            ...
            return this.var_588.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1356.assign(_loc22_);
         }
         else
         {
            this.var_1356.assign(_loc17_);
         }
         ++this.var_183;
      }
      ...
      {
         if(param1 == null || this.var_181 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_181,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_180);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_181);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_483;
         _loc2_.y *= this.var_486;
         _loc2_.z *= this.var_484;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1356);
         if(_loc3_ < this.var_3126 || _loc3_ > this.var_3125)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_180);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_486;
            _loc2_.z *= this.var_484;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1356);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_180,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_483,this.var_105.y * this.var_486,this.var_105.z * this.var_484);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_181;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_483,param2.y * this.var_486,param2.z * this.var_484);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_483,param3.y * this.var_486,param3.z * this.var_484);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_483,param4.y * this.var_486,param4.z * this.var_484);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1231;
         }
         else
         {
            this.scale = const_538;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_538;
      }
