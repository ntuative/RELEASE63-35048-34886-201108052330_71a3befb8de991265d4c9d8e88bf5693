package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1798:int = 0;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_416,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_666,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_926,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_725 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_725 == null || this.var_592 == null)
         {
            return;
         }
         this._state = const_1865;
         if(this.var_1368 != null)
         {
            _loc1_ = this.var_1368;
            this.var_1368 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_724.indexOf(_loc5_) < 0)
            {
               this.var_61.loadObjectContent(_loc5_,events);
               this.var_724.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1181;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_592.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_592.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_725.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_725 != null)
         {
            return this.var_725.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_1032)
         {
            return;
         }
         if(this.var_61 == null)
         {
            this._state = const_1032;
            return;
         }
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_724.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_724.splice(_loc2_,1);
            }
            if(this.var_724.length == 0)
            {
               this._state = const_776;
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1109.length > 0)
         {
            _loc2_ = this.var_1109[0];
            this.var_1109.splice(0,1);
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2896)
            {
               this.var_2118 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_592 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_592.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_592.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_725.createRoomObjectLogic(_loc6_);
