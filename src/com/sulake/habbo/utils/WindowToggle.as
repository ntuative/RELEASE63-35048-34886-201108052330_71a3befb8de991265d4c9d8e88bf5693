package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1299:int = 2;
      ...
      private var var_1470:Function;
      
      private var var_970:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_969)
            {
               this.var_969.addChild(this._window);
            }
