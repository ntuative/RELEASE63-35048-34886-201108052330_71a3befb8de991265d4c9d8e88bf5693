package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1668:int = 10;
      
      private static const const_1124:int = 100;
      
      private static const const_1667:int = 20;
       
      
      private var var_157:HabboMessenger;
      
      private var var_2823:IScrollbarWindow;
      
      private var var_2074:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_578:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_157 = param1;
         this.var_2074 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2823 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1124 + const_1667)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1668;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_578 == null || _loc1_.id != this.var_578.id)
         {
            this.var_578 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_578.followingAllowed)
         {
            this.var_2074.enable();
         }
         else
         {
            this.var_2074.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_578.messages.length - const_1124);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_578.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_578.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_914 || param3.type == Message.const_871 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_578.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_157.send(new FollowFriendMessageComposer(this.var_578.id));
