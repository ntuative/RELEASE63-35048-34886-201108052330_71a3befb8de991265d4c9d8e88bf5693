package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_473:Conversations;
      
      private var var_197:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this._configuration && this._localization && this._friendList && this.var_951 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_473 = new Conversations(new ConversationsDeps(this));
         this.var_197 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_473.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_473.setSelected(_loc2_);
            this.var_197.openMessenger();
            this.var_197.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_473 ? this.var_473.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_473.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_473.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(_loc2_)
         {
            _loc3_ = _loc2_.getImage(AvatarSetType.const_54,true);
            _loc2_.dispose();
            return _loc3_;
         }
         return null;
      ...
      {
         return this.var_197 && this.var_197.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_197)
         {
            if(this.var_197.isMessengerOpen())
            {
               this.var_197.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_871,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1276,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_473.addMessageAndUpdateView(param1);
         if(!this.var_197.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1224);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_473.addMessageAndUpdateView(_loc3_);
      }
