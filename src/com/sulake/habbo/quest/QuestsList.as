package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1530:int = 10;
      
      private static const const_1529:int = 10;
      
      private static const const_1528:int = 30;
      ...
      private var var_1852:Boolean = true;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_777 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_777.toggle();
         this.var_1852 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1527.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1527[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_62.spacing = const_1530;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1529;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1531;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1528;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1852 && !this.var_1851)
            {
               this.var_1852 = false;
