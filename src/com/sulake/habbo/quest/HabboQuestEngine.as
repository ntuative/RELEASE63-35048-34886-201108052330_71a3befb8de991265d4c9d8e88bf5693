package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1532:int = 5;
      
      private static const const_1534:int = 800;
      
      private static const const_1535:int = 15;
      
      private static const const_1533:int = 300;
      ...
      private var var_1248:QuestController;
      
      private var var_662:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1248 = new QuestController(this);
         this.var_662 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1532);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_422.events.removeEventListener(BadgeImageReadyEvent.const_124,this.var_662.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_422.events.addEventListener(BadgeImageReadyEvent.const_124,this.var_662.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1248.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_662.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1248.questTracker.isVisible();
      }
