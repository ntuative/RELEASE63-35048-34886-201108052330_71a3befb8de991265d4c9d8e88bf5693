package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_72,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_664,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_63.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_63.getValue(InventorySubCategory.const_374));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_63.getValue(InventoryCategory.const_149));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_63.getValue(InventoryCategory.const_267));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_63.getValue(InventorySubCategory.const_1241));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_63.getValue(InventoryCategory.const_139));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_63.getValue(InventoryCategory.const_397) as MarketplaceModel;
      }
      ...
      {
         return this.var_116.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_116.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_116.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_116.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_116.clubIsExpiring;
      }
      ...
      {
         return this.var_1300 != null;
      }
      
      public function method_4() : String
      {
         return this._view.method_4();
      }
      ...
      {
         this.var_116.clubPeriods = param1;
         this.var_116.clubDays = param2;
         this.var_116.clubHasEverBeenMember = param3;
         this.var_116.isVIP = param4;
         this.var_116.clubIsExpiring = param5;
      ...
      {
         this.var_422 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_72,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_664,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_81:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_664:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_422 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_63.add(InventoryCategory.const_397,_loc1_);
         ...
         this.var_63.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_422);
         this.var_63.add(InventoryCategory.const_267,_loc3_);
         ...
         this.var_63.add(InventoryCategory.const_149,_loc4_);
         ...
         this.var_63.add(InventorySubCategory.const_374,_loc5_);
         ...
         this.var_63.add(InventorySubCategory.const_1241,_loc6_);
         ...
         this.var_63.add(InventoryCategory.const_139,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1061.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1061.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1061.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1061.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2682)
         {
            this.var_2682 = _loc1_;
