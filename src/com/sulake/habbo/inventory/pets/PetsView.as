package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2134:int = 0;
      
      private const const_1136:int = 1;
      
      private const const_1170:int = 2;
      
      private const const_1168:int = 3;
      ...
      {
         var _loc2_:PetsGridItem = this.var_543.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_543 == null || this.var_543.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_543.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_543.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_543.add(param1.id,_loc2_);
         ...
         if(param1.type == WindowEvent.const_47)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_78.switchToFurnitureCategory(FurniModelCategory.const_43);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1136;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1170;
         }
         else
         {
            _loc2_ = this.const_1168;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1136:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1170:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1168:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_54);
               }
               _loc8_.dispose();
            }
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_449) > 0;
