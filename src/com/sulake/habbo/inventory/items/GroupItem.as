package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_959:int = 0;
      
      protected var var_770:BitmapData;
      ...
      protected var var_3099:BitmapData;
      
      private var var_1706:Boolean;
      
      private const const_2132:Number = 1;
      
      private const const_2133:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2298 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1907));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2274);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_841)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2133;
               _loc1_.blend = this.const_2133;
            }
            else
            {
               this._window.blend = this.const_2132;
               _loc1_.blend = this.const_2132;
            }
         }
         this.var_1579.color = !!this.var_1706 ? uint(const_1591) : uint(const_1592);
         this.var_2686.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2297 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3099;
               _loc5_.visible = true;
            }
            else
            {
