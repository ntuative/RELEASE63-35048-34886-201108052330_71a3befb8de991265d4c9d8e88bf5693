package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2400:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_422 = param5;
         this.var_422.events.addEventListener(BadgeImageReadyEvent.const_124,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_422.events.removeEventListener(BadgeImageReadyEvent.const_124,this.onBadgeImageReady);
            this.var_422 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_896.length)
         {
            if(this.var_896[_loc2_] == param1)
            {
               this.var_896.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1352.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_710.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_422.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_262.unshift(_loc11_);
            }
            else
            {
               this.var_262.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_328);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_262.length)
         {
            _loc3_ = this.var_262[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_669);
         ...
         var _loc3_:Array = this.getBadges(const_328);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_669:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_262)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_328);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_669);
      }
      ...
      {
         if(param1 == InventoryCategory.const_267 && this.var_26.isVisible)
         {
            this.var_26.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_710.indexOf(_loc2_) == -1)
            {
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_710 && this.var_710.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1320));
            this.var_710 = [];
