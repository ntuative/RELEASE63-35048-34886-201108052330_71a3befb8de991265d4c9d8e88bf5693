package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1132:uint = 4284532064;
      
      private static const const_1131:uint = 2577770;
      ...
      private var var_723:ItemPopupCtrl;
      ...
      private var var_1104:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_723 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(this.var_2108 == null)
         {
            this.var_2108 = this.createMinimizedWindow();
         }
         if(!this.var_1173)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1132) : uint(const_1131);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1132) : uint(const_1131);
            }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            this.method_2(this.var_19.ownUserId);
         }
         ...
         if(_loc6_)
         {
            this.method_2(this.var_19.otherUserId);
         }
      }
      ...
      public function removeSelection() : void
      {
         if(this.var_1104)
         {
            this.var_1104.isSelected = false;
            this.var_1104 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1819)
            {
            ...
            this.var_723.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_507);
            this.var_723.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_723.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_203.push(param4);
            this.var_203.push(param1);
            this.var_203.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_203.length > 0)
         {
            _loc2_ = this.var_203.pop();
            _loc3_ = this.var_203.pop();
            _loc4_ = uint(this.var_203.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_723.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_507);
               }
            }
            else
            {
               this.var_203.push(_loc4_);
