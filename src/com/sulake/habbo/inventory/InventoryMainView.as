package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2483:IWindowContainer;
      ...
      private const const_2093:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_808);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_385 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_808);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_139:
               ...
               break;
            case InventoryCategory.const_267:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1831);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_385 == InventoryCategory.const_139)
            {
            ...
            {
               this.var_26.toggleInventoryPage(InventoryCategory.const_78);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1830)
         {
            this.var_1830 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1830,_loc1_);
