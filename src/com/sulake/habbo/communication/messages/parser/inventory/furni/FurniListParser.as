package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3095:int;
      
      protected var var_3096:int;
      
      protected var var_1721:Array;
      ...
      {
         this.var_3097 = param1.readString();
         this.var_3095 = param1.readInteger();
         this.var_3096 = param1.readInteger();
         this.var_1721 = new Array();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_1721.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
