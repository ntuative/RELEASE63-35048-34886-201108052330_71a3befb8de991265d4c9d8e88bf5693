package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_890:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_131.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_197,HabboWindowStyle.const_45,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2106,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_131.habboConfiguration.getKey("use.sso","RoomWidgetChatSelectAvatarMessage") == "true")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_131.habboConfiguration && this.var_131.habboConfiguration.getKey("try.existing.session","RoomWidgetChatSelectAvatarMessage") == "true")
         {
            this.var_1537 = true;
            this._window.visible = false;
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_170,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2106,"/");
         ...
         {
            dispatchEvent(new Event(const_890));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_151.removeEventListener(SSOTicket.const_404,this.onParsedTicketSuccess);
            this.var_151.removeEventListener(SSOTicket.const_365,this.onParsedTicketFailure);
            this.var_151 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_151 = new SSOTicket(this.var_131.assets,_loc3_,_loc2_,param1);
         this.var_151.addEventListener(SSOTicket.const_404,this.onParsedTicketSuccess);
         this.var_151.addEventListener(SSOTicket.const_365,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_151.ticket);
         Logger.log("Has Facebook: " + this.var_151.isFacebookUser);
         if(this.var_151.isFacebookUser)
         {
            this.var_131.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_131.flashClientUrl = this.var_151.flashClientUrl;
         this.var_131.ssoTicket = this.var_151.ticket;
         this.var_151.removeEventListener(SSOTicket.const_404,this.onParsedTicketSuccess);
         this.var_151.removeEventListener(SSOTicket.const_365,this.onParsedTicketFailure);
         this.var_151 = null;
         dispatchEvent(new Event(const_890));
