package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_512:int = 70;
      
      public static const const_1859:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_637:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1872 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1872 = 15;
         }
         this.var_1871 = this._window.height;
         this.var_1535 = 4;
         this.var_825 = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_637:
               ...
               _loc2_ = Number(this.var_1252) / Number(this.var_1018["time_fade_in"]);
               if(this.var_1252 > int(this.var_1018["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1083:
               ...
               if(this.var_1536 > int(this.var_1018["time_display"]) && !this.var_1870)
               {
                  this.startFadeOut();
               }
               break;
            case const_1082:
               ...
               _loc3_ = 1 - Number(this.var_1251) / Number(this.var_1018["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1251 > int(this.var_1018["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1872;
         if(this._window.height < this.var_1871)
         {
            this._window.height = this.var_1871;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1859;
         this._window.y = this.var_1535;
      }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_825;
      }
   }
}
