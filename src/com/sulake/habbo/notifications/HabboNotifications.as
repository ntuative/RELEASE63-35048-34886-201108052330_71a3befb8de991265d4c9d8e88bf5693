package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1583:String = "pixelbalance";
      
      private static const const_1577:String = "badges";
      
      private static const const_1584:String = "selectbadge";
      
      private static const const_1581:String = "inventory";
      
      private static const const_1578:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1579:String = "friendlist";
      
      private static const const_1582:String = "pet_inventory";
      
      private static const const_1580:String = "go_to_room";
      ...
      private var var_1934:IHabboToolbar;
      ...
      private var var_556:HabboNotificationViewManager;
      
      private var var_255:HabboAlertDialogManager;
      
      private var var_843:ParkBusDialogManager;
      
      private var var_2673:Boolean;
      
      private var var_1055:ClubGiftNotification;
      
      private var var_1052:ClubEndingNotification;
      
      private var var_1053:ClubPromoNotification;
      
      private var var_3115:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1783 = false;
         this.var_3115 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1054);
         }
         var _loc6_:Map = this.var_1054["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1054["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_1934 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_556 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1934,this.var_1054["styles"],this.var_1054["view"]);
         ...
         registerUpdateReceiver(this.var_556,1);
         registerUpdateReceiver(this,2);
         this.var_422.events.addEventListener(BadgeImageReadyEvent.const_124,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_422.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1399,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1399,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2052,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_936,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_422.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_422.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_422.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_2021,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_65:
               ...
               break;
            case CatalogPageMessageProductData.const_192:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1321)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1053 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1052 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_556.isSpaceAvailable() && this.var_1294.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_556.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1582:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_139);
               }
               break;
            case const_1578:
               break;
      ...
      {
         if(param1 != null && this.var_556 != null)
         {
            this.var_556.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_360;
            }
            if(param2 == 4057)
            {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_843 == null)
         {
            this.var_843 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_843 != null)
         {
            this.var_843.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1250,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1250,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1020.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_42,3);
               _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_54);
               _loc6_.dispose();
            }
         }
         else
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2673)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_936,null);
            this.var_2673 = true;
      ...
      {
         if(param2.type == WindowEvent.const_170 || param2.type == WindowEvent.const_532)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1055 && this.var_1055.visible)
         {
            return;
         }
         this.var_1055 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1934);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_936,_loc6_);
      }
   }
}
