package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_684:String = "club_gift_notification";
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_684,this._window);
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_684);
         }
         if(this._window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "open_catalog_button":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1777,true);
               }
               this.dispose();
               break;
      ...
      {
         this.var_1946.textColor = const_1500;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_1946.textColor = const_1499;
      }
