package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1623:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_886 = (param2 & 0) > 0;
         this.var_887 = new Dictionary();
         if(!this.var_886)
         {
            lock();
         }
         ...
         this.var_705 = this.getKey("url_prefix");
         if(this.var_705 != null && this.var_705.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_705 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. Failed to load URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1414);
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            Core.error("Could not load external variables, got empty data from URL " + this.getKey("external.variables.txt") + " data length = " + _loc5_ + ". Client startup failed!",false,Core.const_1414);
         }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_705 = this.getKey("url.prefix");
         if(this.var_705.length > 0)
         {
            externalAccessDomain = this.var_705.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_887[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_887[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_705);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_887[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_2041.indexOf(param1) < 0 || param3)
         {
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1623);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1623,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      {
         var _loc3_:String = this.var_887[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }
