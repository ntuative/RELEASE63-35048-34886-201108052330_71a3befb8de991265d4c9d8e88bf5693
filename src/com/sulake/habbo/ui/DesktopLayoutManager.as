package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_712:String = "room_view";
      
      private static const const_1680:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_97.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_181,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_333)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1680) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_97.getChildByTag(const_712) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_97.findChildByTag(const_712) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
