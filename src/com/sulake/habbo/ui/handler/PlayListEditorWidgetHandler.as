package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1474:IMessageEvent;
      
      private var var_1773:IMessageEvent;
      
      private var var_1772:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_175,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_104,this.processSoundManagerEvent);
      ...
      {
         this.var_1474 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1773 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1772 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1474);
         this._connection.addMessageEvent(this.var_1773);
         this._connection.addMessageEvent(this.var_1772);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1474);
               this._connection.removeMessageEvent(this.var_1773);
               this._connection.removeMessageEvent(this.var_1772);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_175,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_104,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_835,RoomWidgetPlayListModificationMessage.const_877,RoomWidgetPlayListModificationMessage.const_752,RoomWidgetPlayListPlayStateMessage.const_864,RoomWidgetPlayListUserActionMessage.const_905];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_835:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_853,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_877:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_752:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_864:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_905:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_290:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1031,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_840,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_818));
               break;
            case PlayListStatusEvent.const_101:
               ...
               break;
            case PlayListStatusEvent.const_175:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_175));
               break;
            case NowPlayingEvent.const_104:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_104,_loc2_.id,_loc2_.position,_loc2_.priority));
               break;
