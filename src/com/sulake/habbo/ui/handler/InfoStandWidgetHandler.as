package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_243.events.addEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
            this.var_243.events.addEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
         }
      }
      ...
      {
         return RoomWidgetEnum.const_657;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_194,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_194,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_243 != null)
         {
            this.var_243.events.removeEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
            this.var_243.events.removeEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
            this.var_243 = null;
         }
         this.var_1172 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_594);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1026);
         _loc1_.push(RoomWidgetFurniActionMessage.const_257);
         _loc1_.push(RoomWidgetFurniActionMessage.const_892);
         _loc1_.push(RoomWidgetFurniActionMessage.const_852);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1006);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1192);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_925);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_814);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_1012);
         _loc1_.push(RoomWidgetUserActionMessage.const_658);
         _loc1_.push(RoomWidgetUserActionMessage.const_502);
         _loc1_.push(RoomWidgetUserActionMessage.const_496);
         _loc1_.push(RoomWidgetUserActionMessage.const_1766);
         _loc1_.push(RoomWidgetPetCommandMessage.const_503);
         _loc1_.push(RoomWidgetPetCommandMessage.const_834);
         _loc1_.push(RoomWidgetUserActionMessage.const_547);
         _loc1_.push(RoomWidgetUserActionMessage.const_258);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_865);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_658)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_258 || param1.type == RoomWidgetUserActionMessage.const_547 || param1.type == RoomWidgetUserActionMessage.const_496)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_594:
            ...
            case RoomWidgetUserActionMessage.const_660:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1419,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_621:
               ...
               break;
            case RoomWidgetUserActionMessage.const_1026:
               this._container.sessionDataManager.openHabboHomePage(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_496:
            ...
            case RoomWidgetFurniActionMessage.const_1006:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1192:
               ...
               break;
            case RoomWidgetUserActionMessage.const_258:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_925:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_814:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_1012:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_303);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_379);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_431) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_431);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_821) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1422;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_303);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1352);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1344);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_437) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_437.length);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_228)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_665)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_342);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_110)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_176)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_895);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_856;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1021;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1831);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_162];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_162:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_895);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_407,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_425,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
