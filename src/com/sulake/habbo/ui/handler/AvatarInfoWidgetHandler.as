package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_788,this.onUserNameUpdate);
         }
         ...
         if(this._container && this._container.sessionDataManager && this._container.sessionDataManager.events)
         {
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_788,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionUserDataUpdateEvent.const_132);
         _loc1_.push(RoomSessionDanceEvent.const_153);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_132:
               this._container.events.dispatchEvent(new RoomWidgetUserDataUpdateEvent());
               break;
            case RoomSessionDanceEvent.const_153:
