package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return RoomWidgetEnum.const_633;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_842,RoomWidgetPresentOpenMessage.const_187];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_842:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_303);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_368);
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_187:
      ...
      {
         return [RoomSessionPresentEvent.const_366];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_366:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_65:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_515,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_245)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_573,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1491)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_377:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_610,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
