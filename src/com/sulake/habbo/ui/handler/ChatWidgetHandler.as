package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_506:Map = null;
      
      private var var_355:Map = null;
      
      private var var_747:Map = null;
      
      private var var_2190:Map = null;
      ...
      private var var_928:Point = null;
      
      private var var_607:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1402 = [];
         this.var_607 = new Vector3d();
         super();
         this.var_506 = new Map();
         this.var_355 = new Map();
         this.var_747 = new Map();
         this.var_2190 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_506.length)
            {
               _loc2_ = this.var_506.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_355 != null)
         {
            ...
            {
               _loc2_ = this.var_355.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1402)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_919,RoomWidgetChatSelectAvatarMessage.const_826];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_919:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_33) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1194))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_33) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1194))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_651);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_826:
      ...
      {
         return [RoomSessionChatEvent.const_205];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_205:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_228)
                           {
                              _loc13_ = this.var_355.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_506.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_747.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_228:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_54);
                                          _loc18_ = _loc17_.getPartColor("ch");
                                          _loc17_.dispose();
                                          if(_loc18_ != null)
                                          {
                                             _loc12_ = uint(_loc18_.rgb);
                                             this.var_747.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_228)
                                    {
                                       this.var_355.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_506.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1401 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1401);
            }
            if(this.var_928 == null)
            {
               ...
               this.var_607.y = 0;
               this.var_607.z = 0;
               this.var_928 = _loc4_.getScreenPoint(this.var_607);
               this.var_1401 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_607.x = 0;
            this.var_607.y = 0;
            this.var_607.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_607);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_928.x || _loc8_.y != this.var_928.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_928,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_355)
         {
            _loc2_ = this.var_355.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_506)
         {
            _loc2_ = this.var_506.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1402.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_747.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2190.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2190.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_355)
            {
               this.var_355.add(_loc3_,param2);
            }
         }
      }
   }
