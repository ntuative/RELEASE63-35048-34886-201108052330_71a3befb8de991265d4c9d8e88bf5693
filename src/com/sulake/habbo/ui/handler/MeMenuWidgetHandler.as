package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_236);
         }
         this.var_1172 = true;
         this.container = null;
         this.var_12 = null;
      ...
      {
         return RoomWidgetEnum.const_600;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               ...
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_211,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_893,this.onHelpTutorialEvent);
         ...
         if(this.var_12 != null)
         {
            ...
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_211,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_893,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1506)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  _loc2_ = _loc5_.getCroppedImage(AvatarSetType.const_54);
                  _loc5_.dispose();
               }
               this.var_1506 = _loc3_;
               this.var_1833 = _loc1_;
               this.var_1834 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1833;
               _loc2_ = this.var_1834;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_477)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_477,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_477 - const_1075)
                  {
                     _loc8_.offset(0,_loc2_.height - const_477 + const_1075);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_789);
         _loc1_.push(RoomWidgetDanceMessage.const_824);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_793);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1297);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1381);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1300);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_765);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_766);
         _loc1_.push(RoomWidgetStopEffectMessage.const_785);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1864);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1330);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_499);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1925);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1267);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_991);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_823);
         _loc1_.push(RoomWidgetMeMenuMessage.const_878);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_819);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_2049);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1017);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_942);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1372);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_429);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_823:
               ...
               break;
            case RoomWidgetWaveMessage.const_789:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_824:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_793:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1297:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1381:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_766:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1361)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_169,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_765:
               ...
               if(this.var_12 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1995:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1349:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_267);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2007:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2018:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1300:
            case RoomWidgetStopEffectMessage.const_785:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1330:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_991:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_878:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_499:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_236,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_236);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_602));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_819:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_448,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_1017:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_448,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_942:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_448,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1372:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_135:
               ...
               break;
            case HabboHelpTutorialEvent.const_893:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_581));
         }
      }
