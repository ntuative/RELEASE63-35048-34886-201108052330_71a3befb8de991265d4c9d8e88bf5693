package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1075:TagListRenderer;
      
      private var var_161:IBorderWindow;
      
      private var var_2979:int;
      
      private var var_2978:Boolean = true;
      
      private const const_720:int = 5;
      
      private const const_2126:int = 3;
      
      private const const_1698:int = 11184810;
      
      private const const_1699:int = 16777215;
      
      private const const_2403:int = 2000;
      
      private const const_2124:int = 50;
      
      private const const_2125:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1075 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2978 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_161.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_161.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_161.x = _loc5_.left - this.var_161.width;
         this.var_161.y = _loc5_.top + (_loc5_.height - this.var_161.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_161.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_161.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_161.x = _loc7_.left - this.var_161.width;
         this.var_161.y = _loc7_.top + (_loc7_.height - this.var_161.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_161 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_161 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_720;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1698;
            }
            else
            {
               _loc5_.textColor = this.const_1699;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_720,this.const_2124);
         _loc5_.height = Math.max(_loc5_.height,this.const_2125);
         _loc3_.height = _loc5_.height + this.const_2126;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_345,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_345,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1075.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_110);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_856:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1021:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2979 > this.const_2403 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2979 = _loc6_;
               _loc3_.textColor = this.const_1699;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1698;
         }
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_720,this.const_2124);
         _loc3_.height = Math.max(_loc3_.height,this.const_2125);
         _loc2_.height = _loc3_.height + this.const_2126;
      }
