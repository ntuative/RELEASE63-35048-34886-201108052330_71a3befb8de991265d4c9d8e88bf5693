package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2384:int = 5;
      
      private const const_2385:int = 5;
      ...
      private var var_1291:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1292 = 0;
         this.var_1291 = param2.rectangle.clone();
         this.var_1291.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1291.width)
         {
            return false;
         }
         if(this.var_1292 + param1.height > this.var_1291.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1291.width)
         {
            this._offsetX = 0;
            this.var_1292 += param1.height + this.const_2385;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1292);
         this._offsetX += param1.width + this.const_2384;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1712 != null && this.var_1712.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_186);
