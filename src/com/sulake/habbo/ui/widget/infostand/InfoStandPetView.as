package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1608:int = 162;
      
      private static const const_1609:int = 16;
      
      private static const const_705:int = 4;
      
      private static const const_1611:uint = 14342874;
      
      private static const const_1605:uint = 3815994;
      
      private static const const_1602:uint = 2085362;
      
      private static const const_1606:uint = 39616;
      
      private static const const_1598:uint = 10513106;
      
      private static const const_1604:uint = 8734654;
      
      private static const const_1601:uint = 9094430;
      
      private static const const_1599:uint = 6200576;
      
      private static const const_1600:String = "happiness";
      
      private static const const_1603:String = "experience";
      
      private static const const_1607:String = "energy";
      
      private static const const_1610:int = 250;
      
      private static const const_1115:int = 25;
      ...
      private var var_221:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1600,param1.nutrition,param1.nutritionMax,const_1606,const_1602);
         this.updateStateElement(const_1603,param1.experience,param1.experienceMax,const_1604,const_1598);
         this.updateStateElement(const_1607,param1.energy,param1.energyMax,const_1599,const_1601);
         ...
         this.updateWindow();
         this.var_573 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_221 && this.var_221.isVisible() && param1.isOwnPet)
         {
            this.var_221.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_221.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1608,const_1609,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1611);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1605);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_705,_loc7_.width - 2,_loc7_.height - 2 - const_705);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_705);
      ...
      private function openTrainView() : void
      {
         if(this.var_221 == null)
         {
            this.var_221 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_573) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_221.showWindow(true);
            this.var_221.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_221 && this.var_221.getPetId() == this.var_573)
               {
                  this.var_221.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1900,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_459,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1115 + const_1114;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1114;
            }
         }
         this.var_108.height = _loc4_ + const_1115;
         this.updateWindow();
      }
   }
}
