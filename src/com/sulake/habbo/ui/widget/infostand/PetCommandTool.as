package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_480:IFrameWindow;
      
      private var var_1336:Map;
      ...
      private const const_2399:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1336 = new Map();
         this.var_409 = new Timer(this.const_2399);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1336.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_573);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1336.getValue(this.var_573) as CommandConfiguration;
      ...
      {
         this.var_1336.remove(param1);
         this.var_1336.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_834,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.position = const_1504;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_480 == null)
         {
            ...
            this.var_480 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_480 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_480.x = 200;
            this.var_480.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_480.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_258,this.var_573));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_503,this.var_573,this.var_2049 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_503,this.var_573,this.var_2049 + " " + _loc5_);
