package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1683:int = 18;
      ...
      private var var_201:RoomChatHistoryPulldown;
      
      private var var_490:Boolean = false;
      
      private var var_489:Number = -1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1172 = false;
         this._widget = param1;
         this.var_201 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_201.state = RoomChatHistoryPulldown.const_312;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1222,HabboWindowStyle.const_45,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_201.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_312);
      }
      ...
      {
         return !!this.var_490 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_201.state == RoomChatHistoryPulldown.const_446 || this.var_201.state == RoomChatHistoryPulldown.const_637;
      }
      ...
      {
         if(!this.var_490 && !this.var_1783)
         {
            this.var_490 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_201.state = RoomChatHistoryPulldown.const_446;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_719;
            }
         }
         if(this.var_201 != null)
         {
            this.var_201.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_489 > 0 && param2)
         {
            if(this.var_2106)
            {
               if(Math.abs(param1 - this.var_489) <= const_1418)
               {
                  return;
               }
               this.var_2106 = false;
            ...
            if(this.var_490)
            {
               ...
               _loc5_ = (param1 - this.var_489) / this.var_54.height;
               _loc3_ = this.var_719 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_489;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1683 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2105)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_719 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_719 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
