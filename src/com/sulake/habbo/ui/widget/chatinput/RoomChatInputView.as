package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1734:int = 250;
      
      private static const const_1732:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1733:String = "${widgets.chatinput.say}";
      ...
      private var var_2189:IWindow;
      
      private var _button:IWindow;
      
      private var var_2188:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1400 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_3027 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_3028 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_424 = new Timer(1000,1);
         this.var_424.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_504 = new Timer(10000,1);
         this.var_504.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_424.reset();
            this.var_424.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_424 = null;
         }
         if(this.var_504 != null)
         {
            this.var_504.reset();
            this.var_504.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_504 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2189 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2188 = this._window.findChildByName("send_button_text");
         this.var_1692 = this._window.findChildByName("block_text");
         this.var_2188.caption = const_1733;
         this.var_27.setParamFlag(HabboWindowParam.const_46,true);
         this.var_27.addEventListener(WindowMouseEvent.const_44,this.windowMouseEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_345,this.keyUpHandler);
         this.var_27.addEventListener(WindowEvent.const_119,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1694 = true;
         this.var_746 = "";
         this._window.addEventListener(WindowEvent.const_671,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_529,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2189.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1734 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1732);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1400 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_746 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_746.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_745);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_127);
