package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1065:String = "use_minimized_own_avatar_menu";
      ...
      private var var_247:AvatarInfoData;
      ...
      private var var_794:AvatarInfoView;
      
      private var var_796:OwnAvatarMenuView;
      
      private var var_795:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_247 = new AvatarInfoData();
         this.var_2416 = Boolean(this._configuration.getBoolean("menu.avatar.enabled",false));
         this.var_1792 = this._configuration.getBoolean("menu.own_avatar.enabled",false);
      ...
      {
         return var_954 as AvatarInfoWidgetHandler;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_176,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_348,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_144,this.updateEventHandler);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_379,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_199,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_420,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_498,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_933,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_176,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_348,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_144,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_379,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_199,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_420,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_498,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_137:
               ...
               if(this.var_1792 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_498:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_348:
               this.var_1794 = true;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_144:
            case RoomWidgetFurniInfoUpdateEvent.const_379:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_933:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1793 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_960,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_442:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1793)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_176:
               _loc3_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.storeUserInfo(_loc3_);
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_130,false,!!_loc3_.isSpectatorMode ? null : this.var_247);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_665,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_114:
               if(this.var_1794)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_228,false,null);
               }
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_199:
               ...
               for each(_loc7_ in this.var_380)
               {
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_99:
               this.var_1766 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_420:
               this.var_1766 = true;
         }
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_372,_loc2_.id,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER);
      ...
      {
         this.var_247.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_247.amIController = param1.amIController;
         this.var_247.amIOwner = param1.amIOwner;
         this.var_247.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_247.canBeKicked = param1.canBeKicked;
         this.var_247.canTrade = param1.canTrade;
         this.var_247.canTradeReason = param1.canTradeReason;
         this.var_247.hasFlatControl = param1.hasFlatControl;
         this.var_247.isIgnored = param1.isIgnored;
         this.var_247.respectLeft = param1.respectLeft;
         this.var_247.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_110;
         this.var_247.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1792) : Boolean(this.var_2416);
         }
            ...
            if(!this.var_1766)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_796)
                     {
                        this.var_796 = new OwnAvatarMenuView(this);
                     }
               ...
               else
               {
                  if(!this.var_794)
                  {
                     this.var_794 = new AvatarInfoView(this);
                  }
                  this._view = this.var_794;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_380.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_380.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_380)
         {
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_236,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_236);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1065,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1065,!!param1 ? "1" : "0");
      }
   }
}
