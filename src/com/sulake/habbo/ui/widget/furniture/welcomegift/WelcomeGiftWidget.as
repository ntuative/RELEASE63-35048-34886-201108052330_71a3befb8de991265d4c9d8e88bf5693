package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1133:String = "welcome_gift_email_verified";
      
      private const const_1684:String = "welcome_gift_email_change";
      
      private const const_2401:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1367)
         {
            this.setViewState(this.const_1133);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_713:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1108;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_29,this.var_1108);
               break;
            case this.const_1133:
            ...
            case this.const_1684:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1108);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1660;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1684);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_1013,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1367 ? this.const_1133 : this.const_713);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1659 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1659));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_903,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_903,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_534:
               this.var_1660 = param1.email;
               this.var_1367 = param1.isVerified;
               this.var_1108 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1660 = this.var_1659;
            this.setViewState(this.const_713);
         }
         else
         {
            if(param1.result == this.const_2401)
            {
               this.var_1108 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1659);
