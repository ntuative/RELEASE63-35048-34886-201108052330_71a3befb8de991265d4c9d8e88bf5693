package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_899:String = "PLSV_ADD_SONGS";
      
      public static const const_1374:String = "PLSV_START_PLAYBACK";
      
      public static const const_597:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_597)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_462[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_462[const_899];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_462.add(const_597,_loc1_);
