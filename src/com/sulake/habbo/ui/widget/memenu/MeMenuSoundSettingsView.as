package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1027:MeMenuSoundSettingsSlider;
      
      private var var_1031:BitmapData;
      ...
      {
         this.var_1032 = param1.volume;
         if(this.var_1027 != null)
         {
            this.var_1027.setValue(this.var_1032);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_1027 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1032 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1031);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1030);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1028);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_1017);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_942);
         }
