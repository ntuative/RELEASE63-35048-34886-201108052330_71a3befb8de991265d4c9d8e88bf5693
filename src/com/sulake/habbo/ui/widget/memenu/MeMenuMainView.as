package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private var var_182:Dictionary;
      ...
      {
         this.var_182 = new Dictionary();
         this.var_182["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_182["dance_icon"] = ["dance_white","dance_color"];
         this.var_182["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_182["effects_icon"] = ["effects_white","effects_color"];
         this.var_182["badges_icon"] = ["badges_white","badges_color"];
         this.var_182["wave_icon"] = ["wave_white","wave_color"];
         this.var_182["hc_icon"] = ["_white","_color"];
         this.var_182["settings_icon"] = ["settings_white","settings_color"];
         this.var_182["credits_icon"] = ["credits_white","credits_color"];
         this.var_182["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_182[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_182[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_182[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc4_ in this.var_182)
         {
            _loc7_ = this.var_182[_loc4_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1259);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1226));
            ...
            case "effects":
               ...
               this._widget.messageListener.processWidgetMessage(new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_429));
               this._widget.hide();
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1349));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_499));
               this._widget.hide();
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1361));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_956);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","RoomWidgetChatSelectAvatarMessage") == "true";
               if(false && _loc4_)
               {
