package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1752:MeMenuSoundSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_415)
         {
            return;
         }
         this.var_1752.saveVolume(this.getValue(param2.x),false);
      }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_779 != null)
               {
                  ...
                  this.var_1753 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
