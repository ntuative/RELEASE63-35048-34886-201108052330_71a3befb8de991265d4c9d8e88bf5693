package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_479:uint = 3;
      
      private static const const_1553:uint = 1;
      ...
      private var var_1546:IEventDispatcher;
      
      private var var_1276:Boolean = false;
      
      private var var_1898:ProfilerOutput;
      
      private var var_1547:ProfilerAgentTask;
      
      private var var_1545:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_218 = new Array(const_479);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_479)
         {
            this.var_218[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_704 = this.var_218[const_1553];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1898)
            {
               this.var_1898 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1898.profiler = _loc3_;
            this.var_1547 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1547);
            this.var_1545 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1545);
            this.var_1276 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_218)
            {
               ...
               {
                  IDisposable(this.var_218.pop()).dispose();
               }
            }
            this.var_218 = null;
            if(this.var_291)
      ...
      {
         return this.var_704.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_704.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_291[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_291[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_218[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_218[param2].getDesktopWindow();
      ...
      {
         return this.var_218[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_218[param1].getDesktopWindow().getChildAt(this.var_704.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_218[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_432.length > 0)
         {
            this.var_1546.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_479 - 1;
            while(_loc2_ >= 0)
            {
               this.var_218[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1276)
         ...
         this.var_1546.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_479)
         {
            this.var_218[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1276)
         {
         ...
         if(WindowContext.var_432.length > 0)
         {
            WindowContext.var_432.flush();
         }
         MouseCursorControl.change();
         this.var_1546.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1822,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1976,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2027,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1970,param2.name + ": " + param2.toString());
            }
         }
      }
