package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1626:uint = 13232628;
      
      private static var var_2047:uint = 11129827;
      ...
      private var var_2045:IWindowContainer;
      ...
      private var var_1335:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_375;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_572 = param1;
         if(this.var_2046 == this.var_572)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2045 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_891)
         {
            this.var_891 = this.var_26.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_891)
            {
               return;
            }
            this._window.content.addChild(this.var_891);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_890)
         {
            this.var_890 = this.var_26.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_890)
            {
               return;
            }
            this._window.content.addChild(this.var_890);
         }
         this._window.caption = this.var_26.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_890.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_572;
         }
         this.showView(this.var_890);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_26.localization.registerParameter("help.tutorial.name.available","name",this.var_572);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1335 = new NameSuggestionListRenderer(this.var_26);
         var _loc6_:int = this.var_1335.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1626;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_572 = this.var_26.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_26.changeName(this.var_572);
               break;
            ...
            case "header_button_close":
               this.var_26.showView(TutorialUI.const_96);
         }
      }
