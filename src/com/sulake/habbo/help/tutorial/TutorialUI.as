package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_405:String = "TUI_CLOTHES_VIEW";
      
      public static const const_636:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_521,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_602,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_524,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_378,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1373 && this.var_1374 && this.var_1666;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_521,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_602,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_524,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_378,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_521:
               this.var_1666 = true;
               if(this.var_53 != null && this.var_53.id == const_636)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_602:
               if(this.var_53 != null && this.var_53.id == const_405)
               {
                  this.var_2132 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2511 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2510;
         this._window.width = _loc2_.width + this.var_2511;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_135));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_375 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1373 = true;
         if(this.var_53 != null && (this.var_53.id == const_405 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
