package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1694)
         {
      ...
      {
         main.showUI(HabboHelpViewEnum.const_494);
      }
      ...
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_802);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_262);
            main.tellUI(HabboHelpViewEnum.const_262,_loc6_);
         }
      }
   }
}
