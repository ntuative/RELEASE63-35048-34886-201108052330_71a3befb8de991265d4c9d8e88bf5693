package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1319:SliderWindowController;
      
      private var var_1318:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1319.getValue());
         _loc2_.push(this.var_1318.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_93 = param2;
         this.var_1319 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1319.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1319.setValue(1);
         this.var_1318 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1318.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1318.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1319.setValue(_loc3_);
         this.var_1318.setValue(_loc4_);
      }
