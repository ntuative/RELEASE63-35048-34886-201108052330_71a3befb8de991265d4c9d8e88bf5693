package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1774 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1189 = this.var_1774.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1189)
         {
            this.var_1189.procedure = this.onButtonClick;
         }
         this.var_1188 = this.var_1774.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1188)
         {
            this.var_1188.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_275 >= this.var_76.length - 1)
         {
            this.var_1188.disable();
         }
         else
         {
            this.var_1188.enable();
         }
         if(this.var_275 <= 0)
         {
            this.var_1189.disable();
         }
         else
         {
            this.var_1189.enable();
         }
      }
      ...
      {
         ++this.var_275;
         this.var_275 = Math.min(this.var_275,this.var_76.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_275;
         this.var_275 = Math.max(this.var_275,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_76[this.var_275][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_76[this.var_275][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_76[this.var_275][1]).value;
