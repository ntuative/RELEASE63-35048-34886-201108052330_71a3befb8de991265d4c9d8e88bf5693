package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_2185:TriggerConfs;
      
      private var var_2186:ActionTypes;
      
      private var var_2187:ConditionTypes;
      
      private var var_308:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_926:RoomObjectHightLighter;
      
      private var var_198:UserDefinedRoomEventsHelp;
      
      private var var_1396:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2185 = new TriggerConfs();
         this.var_2186 = new ActionTypes();
         this.var_2187 = new ConditionTypes();
         this.var_308 = new Dictionary();
         super();
         this.var_93 = param1;
         this.var_926 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_308[param1])
         {
            delete this.var_308[param1];
            this.var_926.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_308[param1] = param2;
            this.var_926.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1396 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1396.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1396.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_926.hideAll(this.var_308);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1396.getValue()) : 0;
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2185);
         this.refreshConfigureElement(this.var_2186);
         this.refreshConfigureElement(this.var_2187);
