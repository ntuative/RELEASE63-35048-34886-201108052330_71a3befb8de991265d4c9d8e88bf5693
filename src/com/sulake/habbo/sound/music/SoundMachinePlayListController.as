package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_243 = param2;
         this.var_823 = [];
         this.var_823.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_823.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_823)
         {
         ...
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_995,this.onSoundMachinePlayEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_1028,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_995,this.onSoundMachinePlayEvent);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_1028,this.onSoundMachineStopEvent);
               this.var_93 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_456 == param1)
         {
            this.playCurrentSongAndNotify(this.var_456);
      ...
      public function stopPlaying() : void
      {
         this.var_456 = -1;
         this.var_654 = false;
         this.var_243.stop(HabboMusicPrioritiesEnum.const_125);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_243.playSong(param1,HabboMusicPrioritiesEnum.const_125,_loc3_,0,0,0))
         {
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.method_7;
