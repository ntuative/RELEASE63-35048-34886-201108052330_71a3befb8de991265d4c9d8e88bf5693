package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_823 = [];
         this.var_823.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_823.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_823.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         if(param1 < 0 || param1 >= this.var_562.length)
         {
            return null;
         }
         return this.var_562[param1];
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_654 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_243.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_125,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1986 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_104,HabboMusicPrioritiesEnum.const_125,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_867.indexOf(_loc5_) < 0)
               {
                  this.var_867.push(_loc5_);
                  this.var_243.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_562.push(_loc7_);
            _loc4_++;
         }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_175));
      }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_562[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_867.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_867.splice(_loc3_,1);
         }
         if(this.var_867.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_101));
