package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_951:IAvatarRenderManager;
      
      private var var_910:ISessionDataManager;
      
      private var var_2941:FriendListLookAndFeel;
      
      private var var_479:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2135:OpenedToWebPopup;
      ...
      private var var_2136:AvatarSearchResults;
      ...
      {
         this.var_2941 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2136 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_734.stop();
            this.var_734.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_734 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2135 = new OpenedToWebPopup(this);
         }
         this.var_2135.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_86);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_411);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_344,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_951.createAvatarImage(param1,AvatarScaleType.const_111,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_54);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         this.var_1066 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1359,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_455,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_479 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_734)
         {
            this.var_734 = new Timer(120000);
            this.var_734.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_734.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_455);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_479.findTab(FriendListTab.const_86).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_479.findTab(FriendListTab.const_86);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2136.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_479.findTab(FriendListTab.const_86);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_479.findTab(FriendListTab.const_86);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_910 || !this.var_123)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_910.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_123.vipLimit;
         }
         else if(this.var_910.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_33))
         {
