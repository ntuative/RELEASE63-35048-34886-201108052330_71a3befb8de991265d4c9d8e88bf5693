package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_460:int = 100;
      ...
      {
         if(this.var_989 >= this.getPageCount())
         {
            this.var_989 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_246.length / const_460);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_989 * const_460;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_989 + 1) * const_460,this.var_246.length);
      }
