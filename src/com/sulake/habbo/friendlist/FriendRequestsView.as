package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2117:String = "no_reqs_info";
      ...
      private var var_2011:IContainerButtonWindow;
      
      private var var_2010:IContainerButtonWindow;
      ...
      {
         this.var_2011 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2010 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2010.procedure = this.onDismissAllButtonClick;
         this.var_2011.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_86,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_183)
         {
         ...
         else if(param1.state == FriendRequest.const_454)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1390)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_409 && _loc2_.state != FriendRequest.const_454)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_454;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2011,_loc1_);
         this.setEnabled(this.var_2010,_loc1_);
      }
