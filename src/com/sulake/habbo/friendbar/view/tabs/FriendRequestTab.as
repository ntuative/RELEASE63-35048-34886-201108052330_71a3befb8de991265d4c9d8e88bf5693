package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2078:String = "friend_request_tab_xml";
      
      protected static const const_466:String = "bubble";
      
      protected static const const_1069:String = "message";
      
      protected static const const_2077:String = "button_accept";
      
      protected static const const_1439:String = "button_close";
      
      protected static const const_1033:String = "click_region_reject";
      ...
      private static const const_1503:uint = 16777215;
      
      private static var var_1484:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1484 ? var_1484 : new FriendRequestTab();
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2078).content as XML) as IWindowContainer;
         ...
         _loc5_.procedure = this.method_6;
         _loc5_.y = -(_loc5_.height - (_loc5_.height - _loc5_.margins.bottom)) - 1;
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_339,WindowStyle.const_103,WindowParam.const_29,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_441,WindowStyle.const_103,WindowParam.const_32,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2077:
                  var_362.acceptFriendRequest(var_169.id);
                  break;
               case const_1439:
                  if(selected)
                  {
                  ...
                  break;
               case const_1033:
                  var_362.declineFriendRequest(var_169.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1033)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1503;
            }
         }
      }
