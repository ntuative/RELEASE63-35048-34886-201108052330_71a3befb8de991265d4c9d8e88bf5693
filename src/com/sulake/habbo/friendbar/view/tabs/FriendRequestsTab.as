package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2083:String = "badge_counter";
      
      protected static const const_2084:String = "button_accept_all";
      
      protected static const const_2082:String = "click_area_discard_all";
      
      protected static const const_1439:String = "button_close";
      
      protected static const const_2077:String = "button_accept";
      
      protected static const const_1035:String = "click_area_discard";
      
      protected static const const_1434:String = "text_discard";
      
      private static var var_1484:FriendRequestsTab;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1484 ? var_1484 : new FriendRequestsTab();
         _loc2_.var_167 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2083).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1909)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1283.clone() as IWindowContainer;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         _loc4_.procedure = this.method_6;
         ...
         this.var_1283 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == const_1035)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1434)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1035)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1434)).textColor = const_1503;
            }
         }
      }
