package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1544:String = "add_friends_tab_xml";
      
      private static const const_1543:String = "find_friends_icon_png";
      
      private static var var_1017:int = -1;
      ...
      private static const const_478:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_478.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1544).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_469));
