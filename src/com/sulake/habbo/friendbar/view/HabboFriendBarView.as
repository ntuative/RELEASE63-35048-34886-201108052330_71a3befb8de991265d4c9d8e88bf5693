package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1701:int = 127;
      ...
      private static const const_1712:Boolean = false;
      
      private static const const_722:int = 3;
      
      private static const const_1708:String = "arrow";
      
      private static const const_1709:String = "left";
      
      private static const const_1706:String = "right";
      
      private static const const_1711:String = "bar_xml";
      
      private static const const_1710:String = "toggle_xml";
      
      private static const const_74:String = "container";
      
      private static const const_1151:String = "wrapper";
      
      private static const const_1704:String = "border";
      ...
      private static const const_1041:String = "pieces";
      
      private static const const_1703:String = "button_left";
      
      private static const BUTTON_RIGHT_SINGLE:String = "button_right";
      
      private static const const_1716:String = "button_left_page";
      
      private static const const_1715:String = "button_right_page";
      
      private static const const_1707:String = "button_left_end";
      
      private static const const_1714:String = "button_right_end";
      
      private static const const_1439:String = "button_close";
      
      private static const const_1705:String = "button_open";
      
      private static const const_1702:String = "link_friendlist";
      
      private static const const_1152:String = "messenger";
      
      private static const const_1150:String = "friendlist";
      
      private static const const_721:String = "stream";
      ...
      private var var_1386:ITab;
      
      private var var_1129:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1678:TextCropper;
      
      private var var_605:FriendListIcon;
      
      private var var_417:MessengerIcon;
      
      private var var_920:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_46)
            {
               if(!this.var_46.disposed)
               {
                  ...
                  {
                     this.var_46.events.removeEventListener(FriendBarUpdateEvent.const_951,this.onRefreshView);
                     this.var_46.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_46.events.removeEventListener(FriendRequestUpdateEvent.const_989,this.onFriendRequestUpdate);
                     this.var_46.events.removeEventListener(NewMessageEvent.const_845,this.onNewInstantMessage);
                     this.var_46.events.removeEventListener(NotificationEvent.const_784,this.onFriendNotification);
                  }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_231)
         {
            ...
            if(this.var_47)
            {
               this.var_231.x = this.var_47.x;
               this.var_231.y = this.var_47.y;
      ...
      public function populate() : void
      {
         ...
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_47.findChildByName(const_74) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_724) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1677 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1677)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_75.length + _loc15_ < const_722)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_75.length,const_722 - this.var_75.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_46.events.addEventListener(FriendBarUpdateEvent.const_951,this.onRefreshView);
         this.var_46.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_46.events.addEventListener(FriendRequestUpdateEvent.const_989,this.onFriendRequestUpdate);
         this.var_46.events.addEventListener(NewMessageEvent.const_845,this.onNewInstantMessage);
         this.var_46.events.addEventListener(NotificationEvent.const_784,this.onFriendNotification);
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_362 = this.var_46;
         Tab.var_514 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2254 = var_435;
         Tab.var_2232 = this.var_1678;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1711);
         this.var_47 = _windowManager.buildFromXML(_loc1_.content as XML,const_490) as IWindowContainer;
         this.var_47.x = const_723;
         this.var_47.y = this.var_47.parent.height - (this.var_47.height + const_1713);
         this.var_47.width = this.var_47.parent.width - (const_723 + const_1149);
         this.var_47.setParamFlag(WindowParam.const_315,true);
         this.var_47.procedure = this.barWindowEventProc;
         if(const_1712)
         {
            _loc1_ = assets.getAssetByName(const_1710);
            this.var_231 = _windowManager.buildFromXML(_loc1_.content as XML,const_490) as IWindowContainer;
            this.var_231.x = this.var_47.x;
            this.var_231.y = this.var_47.y;
            this.var_231.setParamFlag(WindowParam.const_315,true);
            this.var_231.visible = false;
            this.var_231.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_47.findChildByName(const_1150));
         ...
         this.var_605 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_47.findChildByName(const_1152));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         ...
         this.var_47.findChildByName(const_721).visible = var_761.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_47.findChildByName(const_721));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_920 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_951)
         {
            _loc3_ = var_951.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_47.findChildByName(const_724) as IItemListWindow;
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     _loc10_ = _loc9_.getChildByName(const_1041) as IItemListWindow;
                     if(_loc10_)
                     {
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_616);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_605)
         {
            this.var_605.notify(this.var_46.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            _loc4_ = this.var_46.numFriends + (!!this.var_1677 ? 1 : 0) + (this.var_46.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               case const_1703:
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_47.findChildByName(const_1151) as IWindowContainer;
         _loc5_ = [];
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1709,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         if(!disposed)
         {
            if(this.var_47)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_75.length < const_722)
                     {
                        param1 = true;
                     }
                     else if(this.var_75.length < this.var_46.numFriends + (!!this.var_1677 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      {
         var _loc1_:IWindowContainer = this.var_47.findChildByName(const_74) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1151) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_724) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1701 + _loc3_.spacing);
      }
