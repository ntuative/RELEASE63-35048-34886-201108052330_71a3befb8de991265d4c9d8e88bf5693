package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_322:Boolean = false;
      
      private static const const_1173:Boolean = false;
      
      private static const const_733:String = "Navigation";
      
      private static const const_734:String = "Friend Bar";
      
      private static const const_1757:String = "go.friendbar";
      
      private static const const_1756:String = "chat_btn_click";
      
      private static const const_1758:String = "find_friends_btn_click";
      
      private static const const_1175:String = "Toolbar";
      
      private static const const_1172:String = "open";
      
      private static const const_1174:String = "close";
      
      private static const const_1754:String = "FRIENDLIST";
      
      private static const const_1755:String = "MESSENGER";
       
      
      private var var_1153:IHabboConfigurationManager;
      
      private var var_94:IHabboCommunicationManager;
      
      private var var_90:IHabboFriendList;
      
      private var var_236:IHabboMessenger;
      
      private var var_429:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1153)
            {
               this.var_1153.release(new IIDHabboConfigurationManager());
               this.var_1153 = null;
            }
            if(this.var_94)
            {
            ...
            if(this.var_236)
            {
               this.var_236.release(new IIDHabboMessenger());
               this.var_236 = null;
            }
            if(this.var_429)
            {
               this.var_429.release(new IIDHabboEventStream());
               this.var_429 = null;
            }
            this.var_117 = null;
      ...
      {
         return this.var_358.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_733,const_734,const_1757));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_236)
         {
            this.var_236.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_733,const_734,const_1756));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_733,const_734,const_1758));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_90)
         {
            if(!this.var_90.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1175,const_1754,!!this.var_90.isOpen() ? const_1172 : const_1174));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_236)
         {
            ...
            {
               this.var_236.toggleMessenger();
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1175,const_1755,!!this.var_236.isOpen() ? const_1172 : const_1174));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_429)
         {
            if(!this.var_429.disposed)
            {
               this.var_429.visible = !this.var_429.visible;
            }
         }
      }
      ...
      public function refreshOfflineStream() : void
      {
         if(this.var_429)
         {
            if(!this.var_429.disposed)
            {
               this.var_429.refreshEventStream();
            }
         }
      }
      ...
      {
         this.var_1153 = param2 as IHabboConfigurationManager;
         this.var_3057 = this.var_1153.getBoolean("friendbar.notifications.enabled",false);
         this.var_2217 = this.var_1153.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_236 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_429 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_358.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_358.remove(_loc8_);
               this.var_117.splice(this.var_117.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_358.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_322)
               {
               ...
               {
                  this.var_358.remove(_loc4_.id);
                  this.var_117.splice(this.var_117.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_322)
            {
               ...
               this.var_358.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_322)
            {
               if(this.var_358.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_117 = !!const_322 ? this.sortByNameAndOnlineStatus(this.var_117) : this.sortByName(this.var_117);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_940 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_236)
         {
            if(this.var_236.isOpen())
            {
               _loc4_ = this.var_236.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_940)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_940));
            this.makeNotification(String(this.var_940),FriendNotification.const_439,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_940 = _loc2_.senderId;
         if(this.var_236 && !this.var_236.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_940));
            this.makeNotification(String(this.var_940),FriendNotification.const_439,null,true,false);
         }
      }
