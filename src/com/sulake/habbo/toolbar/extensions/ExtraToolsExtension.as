package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1506:uint = 16777215;
      
      private static const const_1505:uint = 12247545;
      
      private static const const_1507:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_405 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_62.removeListItem(this.var_405);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_405,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_323)
         {
            this.var_323 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_323.x = _loc1_.x + this._window.width - this.var_323.width;
            this.var_323.y = _loc1_.y + this._window.height - this.var_323.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1507);
               break;
