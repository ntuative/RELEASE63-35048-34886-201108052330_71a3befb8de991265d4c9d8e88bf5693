package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1452:uint = 4285767869;
      
      private static const const_1453:uint = 4283664040;
      
      private static const const_489:Array = ["icon_pixel_0_png","icon_pixel_1_png","icon_pixel_2_png","icon_pixel_3_png"];
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_349,this.onPixelBalance);
      }
      
      override protected function onContainerClick(param1:WindowMouseEvent) : void
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1789);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1737 != 0)
         {
            if(this.var_1737 > param1.balance)
            {
