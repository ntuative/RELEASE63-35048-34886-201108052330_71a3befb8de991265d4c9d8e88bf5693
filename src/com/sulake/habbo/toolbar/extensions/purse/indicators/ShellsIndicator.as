package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_489:Array = ["icon_shell_0_png","icon_shell_1_png","icon_shell_2_png","icon_shell_3_png"];
       
      
      private const const_1452:uint = 4.283212437E9;
      
      private const const_1453:uint = 4.282748017E9;
      ...
      public function ShellsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.bgColorLight = this.const_1452;
         this.bgColorDark = this.const_1453;
         this.textElementName = "amount";
         this.textElementShadowName = "amount_shadow";
         this.iconAnimationSequence = const_489.concat(const_489).concat(const_489);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.shells.zero.amount.text","Info");
         createWindow("purse_indicator_shells_xml",const_489[0]);
         this.setAmount(0);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_367,this.onShellBalance);
      }
      
      override protected function onContainerClick(param1:WindowMouseEvent) : void
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1884,true);
      }
      ...
      private function onShellBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2155 != 0)
         {
            if(this.var_2155 > param1.balance)
            {
