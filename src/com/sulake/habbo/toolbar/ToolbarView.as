package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1504:Point = new Point(3,3);
      
      private static const const_1634:uint = 7433577;
      
      private static const const_1629:uint = 5723213;
      
      private static const const_483:String = "_hover";
      
      private static const const_481:String = "_normal";
      
      private static const const_482:int = 5;
      
      private static const const_1635:int = 600;
      
      private static const const_1632:int = 80;
      
      private static const const_1633:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1631:int = -2;
      
      private static const const_1628:int = 5;
      ...
      private var var_1608:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1504;
         this._window.addEventListener(WindowEvent.const_671,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_481);
         }
         ...
         this.var_222.x = _loc13_.width - this.var_222.width - const_482;
         this.var_222.y = const_482;
         this.var_2751 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1635;
         if(!param1 && _loc2_ == this.var_1609)
         {
            return;
         }
         this.var_1609 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1633) : int(const_1632);
         var _loc4_:int = !!_loc2_ ? int(const_1631) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1628 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1630;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_222 != null && this.var_2751)
               {
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_481);
               this.setIconBgHoverState(_loc3_,const_481);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_483 ? this.var_1608 : this.var_1607;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_483)
         {
            param1.color = const_1634;
         }
         else
         {
            param1.color = const_1629;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1609 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1609 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1607 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1608)
         {
            this.var_1608.dispose();
         }
         this.var_1608 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1079.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_482;
            this.var_1079.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","RoomWidgetChatSelectAvatarMessage") == "true";
      }
   }
}
