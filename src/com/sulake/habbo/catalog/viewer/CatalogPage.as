package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2091:String = "ctlg_";
       
      
      protected var var_2296:XML;
      ...
      private var var_576:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1341:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_576 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1342);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1342);
      }
      ...
      {
         var _loc2_:String = const_2091 + param1;
         ...
         this.var_2296 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2296) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_2017:
               if(this.var_1341 == null)
               {
                  this.var_1341 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1341);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1857:
               ...
               break;
            case CatalogWidgetEnum.const_2008:
            ...
            case CatalogWidgetEnum.const_1824:
               ...
               break;
            case CatalogWidgetEnum.const_2066:
            ...
            case CatalogWidgetEnum.const_1957:
               ...
               break;
            case CatalogWidgetEnum.const_1896:
            ...
            case CatalogWidgetEnum.const_1929:
               ...
               break;
            case CatalogWidgetEnum.const_2067:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_576.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_576 != null)
         {
            return this.var_576.dispatchEvent(param1);
         }
         return false;
      }
