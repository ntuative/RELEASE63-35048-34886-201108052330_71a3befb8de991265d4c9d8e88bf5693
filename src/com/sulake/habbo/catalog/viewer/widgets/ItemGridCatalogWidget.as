package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_515:IItemGridWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_515 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_775 >= 0 && this.var_775 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_775];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2125) as IWindowContainer;
         this.var_515.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_624)
         {
            ++this.var_1739;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1739);
         }
      }
