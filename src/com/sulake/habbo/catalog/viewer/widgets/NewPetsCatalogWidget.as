package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1522:int = 18;
      ...
      private var var_225:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_542 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_542 < 8)
         {
            return false;
         }
         this.var_2466 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_225 != null && this.var_225.length > 0)
         {
            this.var_384 = this.var_225[0];
         }
         else
         {
            this.var_384 = -1;
         }
         this._offers.add(this.var_542,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_225 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1522 && _loc2_ < this.var_225.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_542,this.var_225[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_225 != null && this.var_225.length > 0)
         {
            if(param1 < 0 || param1 > this.var_225.length)
            {
               param1 = 0;
            }
            this.var_384 = this.var_225[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_542,this.var_384),this.getRaceLocalizationKey(this.var_542,this.var_384));
            }
         }
         return this.getRaceLocalizationKey(this.var_542,this.var_384);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_384 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_542;
         var _loc3_:int = this.var_384;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_384 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
