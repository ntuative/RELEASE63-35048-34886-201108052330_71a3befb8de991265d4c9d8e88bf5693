package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1090:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1090.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1090 = null;
         }
         if(this.var_1091 != null)
         {
            this.var_1091.removeEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
            this.var_1091 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1090 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1090 != null)
         {
            this.var_1090.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1091 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1091 != null)
         {
            this.var_1091.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         }
         return true;
      }
