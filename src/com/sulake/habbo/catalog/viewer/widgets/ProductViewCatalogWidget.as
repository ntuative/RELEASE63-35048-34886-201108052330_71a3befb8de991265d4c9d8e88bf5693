package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_613:IDisplayObjectWrapper;
      
      private var var_2215:Point;
      
      private var var_612:IItemGridWindow;
      
      private var var_1715:IScrollbarWindow;
      
      protected var var_2125:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1152 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1420 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_208 != null)
         {
            ...
            this.var_613 = this.var_208.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_613 != null && _loc3_ != null)
            {
               this.var_208.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_613.width,this.var_613.height);
               if(_loc4_ != null)
               {
                  this.var_613.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2215 = new Point(this.var_100.x,this.var_100.y);
         this.var_612 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1715 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_612 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2125 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_612 != null)
         {
            this.var_612.visible = false;
            this.var_612.destroyGridItems();
         }
         if(this.var_1715 != null)
         {
            this.var_1715.visible = false;
         }
         ...
         this.var_1152.text = _loc4_;
         this.var_1420.text = _loc5_;
         this.var_1152.height = this.var_1152.textHeight + 5;
         this.var_1420.y = this.var_1152.y + this.var_1152.height;
         this.var_1420.height = Math.max(130,this.var_1420.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_624:
                  ...
                  if(this.var_612 != null)
                  {
                     this.var_612.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_612,this.var_1715,this.var_2125);
                     this.var_612.scrollV = 0;
                  }
                  if(this.var_208 != null)
                  {
                     this.var_208.visible = false;
               ...
               case Offer.const_436:
                  _loc9_ = _loc2_.productContainer.firstProduct;
                  if(this.var_208 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_71 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_192)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_71:
                        if(_loc8_ != null && this.var_613 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_383,AvatarAction.const_576);
                                 _loc18_.appendAction(AvatarAction.const_370,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_3056)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_3056 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            this.var_100.x = this.var_2215.x;
            this.var_100.y = this.var_2215.y;
            if(param3 != null)
            {
