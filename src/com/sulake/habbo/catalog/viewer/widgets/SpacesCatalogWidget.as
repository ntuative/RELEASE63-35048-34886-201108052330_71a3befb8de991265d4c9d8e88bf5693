package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_245:String = "wallpaper";
      ...
      private var _floorType:String = "EffectsView";
      ...
      private var var_1479:String = "EffectsView";
      ...
      private var var_1478:String = "1.1";
      
      private var var_987:Dictionary;
      
      private var var_1199:Dictionary;
      
      private var var_1202:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_987 = this.parseElements(_loc2_.floors.pattern);
         this.var_1199 = this.parseElements(_loc2_.walls.pattern);
         this.var_1202 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_987)
                  {
                     _loc11_ = this.var_987[_loc10_];
                     if(this.var_634.indexOf(_loc10_) == -1)
                     {
                        this.var_634.push(_loc10_);
                        this.var_1200.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1199[_loc8_] != null)
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1202[_loc8_] != null)
                  {
                     this.var_790.push(_loc8_);
         ...
         this.changePattern(const_245,0);
         this.changePattern(TYPE_LANDSCAPE,0);
         this.updateConfiguration();
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1479,this.var_1478,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            case "ctlg_wall_pattern_prev":
               this.changePattern(const_245,-1);
               break;
            case "ctlg_wall_pattern_next":
               this.changePattern(const_245,1);
               break;
            case "ctlg_wall_color_prev":
               this.changeColor(const_245,-1);
               break;
            case "ctlg_wall_color_next":
               this.changeColor(const_245,1);
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1201[this.var_446];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1479);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1200[this.var_444];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_448];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1478);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_634[this.var_444];
         var _loc3_:Array = this.var_987[_loc2_];
         if(_loc3_ != null && this.var_449 >= 0)
         {
            _loc11_ = _loc3_[this.var_449];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1200[this.var_444];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_789[this.var_446];
         var _loc6_:Array = this.var_1199[_loc5_];
         if(_loc6_ != null && this.var_445 >= 0)
         {
            _loc13_ = _loc6_[this.var_445];
            if(_loc13_ != null)
            {
               this.var_1479 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1201[this.var_446];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_790[this.var_448];
         var _loc9_:Array = this.var_1202[_loc8_];
         if(_loc9_ != null && this.var_447 >= 0)
         {
            _loc15_ = _loc9_[this.var_447];
            if(_loc15_ != null)
            {
               this.var_1478 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_448];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_112:
               ...
               if(this.var_444 < 0)
               {
                  this.var_444 = this.var_634.length - 1;
               }
               if(this.var_444 >= this.var_634.length)
               {
                  this.var_444 = 0;
               }
               this.var_449 = 0;
               this.var_985 = 0;
               _loc5_ = this.var_634[this.var_444];
               _loc6_ = this.var_987[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_985 = _loc6_.length;
               }
            ...
            case const_245:
               ...
               if(this.var_446 < 0)
               {
                  this.var_446 = this.var_789.length - 1;
               }
               if(this.var_446 == this.var_789.length)
               {
                  this.var_446 = 0;
               }
               this.var_445 = 0;
               this.var_984 = 0;
               _loc7_ = this.var_789[this.var_446];
               _loc8_ = this.var_1199[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_984 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_448 < 0)
               {
                  this.var_448 = this.var_790.length - 1;
               }
               if(this.var_448 >= this.var_790.length)
               {
                  this.var_448 = 0;
               }
               this.var_447 = 0;
               this.var_986 = 0;
               _loc9_ = this.var_790[this.var_448];
               _loc10_ = this.var_1202[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_986 = _loc10_.length;
               }
