package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         if(this.var_26 != null)
         {
            this.var_26.unRegisterVisualization(this);
         }
         this.var_26 = null;
         this.reset();
         super.dispose();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_26 = (page.viewer.catalog as HabboCatalog).getClubBuyController();
         this.var_26.registerVisualization(this);
         this.var_26.requestOffers();
         return true;
      }
