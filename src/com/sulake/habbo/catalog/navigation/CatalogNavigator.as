package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3147:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_1003,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_209,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_807,this.deActivateScrollbar);
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_399.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_399)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_399.indexOf(_loc6_);
            this.var_399.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_399.indexOf(param1) == -1)
         {
            this.var_399.push(param1);
         }
