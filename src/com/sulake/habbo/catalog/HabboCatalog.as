package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_726:uint = 1;
      ...
      private var var_1300:IRoomSession;
      ...
      private var var_233:CatalogViewer;
      
      private var var_265:ICatalogNavigator;
      
      private var var_116:Purse;
      
      private var var_106:RecyclerLogic;
      
      private var var_163:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_205:PurchaseConfirmationDialog;
      
      private var var_234:ChargeConfirmationDialog;
      ...
      private var var_3020:Boolean = true;
      
      private var var_3023:Boolean = true;
      
      private var var_2181:Boolean = false;
      
      private var var_3022:GiftWrappingConfiguration;
      
      private var var_1393:ClubGiftController;
      
      private var var_606:ClubBuyController;
      
      private var var_924:ClubExtendController;
      
      private var var_923:Map;
      
      private var var_1392:Boolean = false;
      
      private var var_925:IPurchasableOffer;
      
      private var var_1690:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_72,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_2062);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_422.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_116.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_116.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_205 == null || this.var_205.disposed)
            {
               this.var_205 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_205.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_606.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3021 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_422.loadProductData(this);
      }
      ...
      {
         if(this._roomEngine != null && this._configuration != null && this._configuration.getKey("catalog.furniture.animation","RoomWidgetChatSelectAvatarMessage") == "true")
         {
            if(this.var_742 == null)
            {
               this.var_742 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_886 || !this.var_265 || !this.var_265.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1136 = -1;
            this.var_922 = param1;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this._configuration.getKey("client.credits.embed.enabled","RoomWidgetChatSelectAvatarMessage") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_422.getProductData(param1);
      }
      
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_71)
         {
            _loc3_ = this.var_422.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_422.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_116.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_116.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_116.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_116.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_116.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_116.clubPeriods));
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_106.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_106.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_233.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_233 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_233.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_726) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2093;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_72:
               this.var_2181 = param1.session.isPrivateRoom;
               this.var_1300 = param1.session;
               if(this.var_106 != null)
               {
                  this.var_106.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_81:
               ...
               if(this.var_106 != null)
               {
                  this.var_106.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_106 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_163 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1393 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_606 == null)
         {
            this.var_606 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_924 == null)
         {
            this.var_924 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_233 != null)
         {
            this.var_233.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1689 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         ...
         else if(this.var_1136 > -1)
         {
            this.var_265.openPageById(this.var_1136,this.var_2182);
            this.var_1136 = -1;
            this.var_2182 = -1;
            this.var_922 = "";
         }
         else if(this.var_1689 && this.var_3021)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_265.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1765));
         }
         else
         {
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_233.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_233 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_233.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_116.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_3020 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1253);
         }
         this.var_3020 = false;
         if(this.var_234 != null && !this.var_234.disposed)
         {
            this.var_234.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_128,this.var_116.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_116.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_3023 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1281);
         }
         this.var_3023 = false;
         if(this.var_234 != null && !this.var_234.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_349,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_944)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_367,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_116.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_349,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_367,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_116.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_116.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_116.isVIP = _loc2_.isVIP;
         this.var_116.pastClubDays = _loc2_.pastClubDays;
         this.var_116.pastVipDays = _loc2_.pastVipDays;
         this.var_116.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1294 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1393.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_106 == null)
         {
            return;
         }
         this.var_106.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_106.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_106.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_163 != null)
         {
            this.var_163.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_163 != null)
         {
            this.var_163.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_163 != null)
         {
            this.var_163.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_3022 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_163.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_234 == null || this.var_234.disposed)
         {
            this.var_234 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_234.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_233.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1300 || !this.var_1300.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_229);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_220);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1392 && param1.type == RoomEngineObjectEvent.const_171)
         {
            ...
            if(this.var_925 == null || this.var_925.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_925.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_925);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_361,0.5);
            }
         }
      }
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_360:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_220);
                  ...
                  case FurniCategory.const_363:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_229);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_726);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_742 != null)
         {
            this.var_742.updatePreviewRoomView();
         }
      }
   }
}
