package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1491:String = "poster";
       
      
      public const const_2318:int = 1;
      
      public const const_2301:int = 2;
      
      public const const_2411:int = 3;
      ...
      private var var_3051:MarketplaceItemStats;
      ...
      private var var_3053:int = 0;
      
      private var var_3052:int = 0;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_312);
            this.var_312 = null;
         }
         if(this.var_357 != null)
         {
            this.disposeOffers(this.var_357);
            this.var_357 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_205)
         {
            this.var_205 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_205.showConfirmation(param1,param2);
      }
      ...
      public function requestOffers(param1:int, param2:int, param3:String, param4:int) : void
      {
         ...
         this.var_3052 = param2;
         this.var_2515 = param3;
         this.var_3054 = param4;
         if(this._catalog)
         {
      ...
      {
         this.requestOffers(this.var_3053,this.var_3052,this.var_2515,this.var_3054);
      }
      ...
      {
         if(!this.var_312 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_312.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2318,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_357.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_357.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_531)
            {
               this.var_357.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_312.add(_loc4_.offerId,_loc5_);
         }
         this.var_2773 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2806 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_357.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_312.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_312.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_312.add(parser.offerId,updateItem);
            }
            this.var_312.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2301,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_357.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2317 || param1.furniTypeId != this.var_2315)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1491)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_76)
            {
