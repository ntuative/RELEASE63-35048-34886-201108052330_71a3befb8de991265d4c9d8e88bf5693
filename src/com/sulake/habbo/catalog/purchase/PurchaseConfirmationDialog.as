package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2371:int = 10;
      ...
      private const const_2131:uint = 4.293848814E9;
      
      private const const_2130:uint = 4.294967295E9;
      
      private const const_1505:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1242 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_345,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_330,this.onMessageInputFocus);
         }
         this.var_1845 = true;
         this.var_1847 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_653,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1846 = _loc1_.stuffTypes;
            this.var_820 = _loc1_.boxTypes;
            this.var_822 = _loc1_.ribbonTypes;
            this.var_1243 = this.var_1846[0];
            this.var_394 = this.var_820[0];
            this.var_392 = this.var_822[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_392 < 0)
         {
            this.var_392 = this.var_822.length - 1;
         }
         if(this.var_392 > this.var_822.length - 1)
         {
            this.var_392 = 0;
         }
         if(this.var_394 < 0)
         {
            this.var_394 = this.var_820.length - 1;
         }
         if(this.var_394 > this.var_820.length - 1)
         {
            this.var_394 = 0;
         }
         var _loc1_:int = this.var_820[this.var_394] * 1000 + this.var_822[this.var_392];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1243,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1243);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_820[this.var_394]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_822[this.var_392]);
         this._catalog.purchaseProductAsGift(this.var_1514,this.var_1242,this.var_1516,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1514,this.var_1242,this.var_1516);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_246)
         {
            ...
            if(_loc4_.length >= this.const_2371)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2525 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_393 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_393 + 1);
               break;
      ...
      {
         if(this.var_288 == null || !this.var_288.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_288.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_393) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_288 == null)
         {
            this.var_288 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_821 == null)
         {
            this.var_821 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_288 == null || this.var_821 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_288.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_821.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_288.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_393) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_393);
         }
         this.var_393 = param1;
         if(this.var_393 < 0)
         {
            this.var_393 = _loc2_.numListItems - 1;
         }
         if(this.var_393 >= _loc2_.numListItems)
         {
            this.var_393 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_393) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1505;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2131) : uint(this.const_2130);
      }
      ...
      {
         this.var_1243 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1243;
               }
            }
            _loc4_++;
         }
