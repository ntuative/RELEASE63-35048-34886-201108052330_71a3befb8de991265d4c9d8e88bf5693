package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_310:int = 4;
      
      public static const const_316:int = 5;
      
      public static const const_763:int = 6;
      
      public static const const_2069:int = const_423;
      ...
      public static const const_293:int = 2;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2552 = param6;
         this.var_2553 = param7;
         if(this.var_2076 == const_763)
         {
            this.var_2129 = false;
         }
      }
      ...
      public function clearCache() : void
      {
         ...
         this.var_731 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_414.length)
         {
            _loc2_ = this.var_414[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_414.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_414[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_414[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_33 != null)
            {
               if(this.var_33.width == param2 && this.var_33.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_731,param6,param7);
                     return param1;
                  }
                  return this.var_33;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_414.length)
         {
            _loc11_ = this.var_414[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_33.width,this.var_731);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_33.height - this.var_731,this.var_33.width,this.var_731);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         {
            _loc4_ = this.var_414[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
