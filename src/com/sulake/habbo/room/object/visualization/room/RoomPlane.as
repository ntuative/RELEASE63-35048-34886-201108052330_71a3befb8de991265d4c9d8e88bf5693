package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1134:IPlaneRasterizer = null;
      
      private var var_918:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_3016:Number = 0;
      
      private var var_3019:Number = 0;
      
      private var var_3017:Number = 0;
      
      private var var_3018:Number = 0;
      ...
      private var var_921:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_3016 = param9;
         this.var_3019 = param10;
         this.var_3017 = param11;
         this.var_3018 = param12;
         this.var_1133 = param6;
      }
      
      public function set canBeVisible(param1:Boolean) : void
      {
         if(param1 != this.var_921)
         {
            if(!this.var_921)
            {
      ...
      {
         return this._isVisible && this.var_921;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_725);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1134.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_921 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_421))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_344.length * param1.scale;
            _loc6_ = this.var_345.length * param1.scale;
            ...
            if(this.var_1134 != null)
            {
               _loc3_ = this.var_1134.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2175,this.var_3016,this.var_3019,this.var_3017,this.var_3018,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1881 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_921)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1533.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1533[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1358);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_184.z - originZ,this.var_140.z - originZ,this.var_98.z - originZ,this.var_139.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2877 = relativeDepth;
            this._isVisible = true;
            this.var_1881 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_3015);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1133)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_420.length)
            {
               _loc5_ = this.var_420[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_307.length == this.var_1135.length)
         {
            while(_loc1_ < this.var_307.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1135.length)
                  {
                     _loc7_ = this.var_1135[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_420.length > this.var_1687.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1133 || this.var_307.length == 0 && this.var_420.length == 0 && !this.var_421 || this.var_918 == null)
         {
            return;
         }
         ...
         if(this.var_421)
         {
            ...
            while(_loc5_ < this.var_307.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc3_.leftSideLoc / this.var_344.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc3_.rightSideLoc / this.var_345.length;
                  _loc12_ = _loc3_.type;
                  this.var_918.updateMask(this.var_81,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1135.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_420.length)
            {
               _loc4_ = this.var_420[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc4_.leftSideLoc / this.var_344.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc4_.rightSideLoc / this.var_345.length;
                  _loc13_ = this.var_81.width * _loc4_.leftSideLength / this.var_344.length;
                  _loc14_ = this.var_81.height * _loc4_.rightSideLength / this.var_345.length;
                  this.var_81.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1687.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_421 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_264.copyChannel(param1,param1.rect,const_725,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_264.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_264,this.var_264.rect,const_725,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
