package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1911:int = 16777215;
      
      public static const const_1941:int = 13421772;
      
      private static const const_1088:int = 16777215;
      
      private static const const_1086:int = 13421772;
      
      private static const const_1089:int = 10066329;
      
      private static const const_1087:int = 10066329;
      
      public static const const_1950:int = 16777215;
      
      public static const const_1779:int = 13421772;
      ...
      private var var_828:Rectangle = null;
      
      private var var_548:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1124:Number = NaN;
      
      private var var_1539:Number = NaN;
      
      private var var_2607:Number = NaN;
      
      private var var_1884:String = null;
      
      private var var_1258:uint = 16777215;
      
      private var var_2604:int = 255;
      
      private var var_2602:int = 255;
      
      private var var_2606:int = 255;
      ...
      private const const_2381:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_548 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_152 != null)
         {
            ...
            {
               _loc2_ = this.var_152[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_828 = super.boundingRectangle;
         }
         return new Rectangle(this.var_828.x,this.var_828.y,this.var_828.width,this.var_828.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_152.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_152[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_76 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_76)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1124))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1124;
         }
         if(!isNaN(this.var_1539))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1539;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_779);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1211);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_76,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1087;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1088;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1086;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_434)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1950;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1779;
               }
               else
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_434)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2381 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_395.length)
            {
               _loc11_ = this.var_663[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_395[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1883)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2606 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2602 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2604 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1881)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1652 || _loc3_.y != this.var_2605 || _loc3_.z != this.var_2603 || param1.scale != this.var_1882))
            {
               this.var_1652 = _loc3_.x;
               this.var_2605 = _loc3_.y;
               this.var_2603 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_145 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1286);
            if(_loc3_ != this.var_1884)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1884 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1007));
            if(_loc4_ != this.var_1258)
            {
               this.var_1258 = _loc4_;
               this.var_2606 = this.var_1258 & 255;
               this.var_2602 = this.var_1258 >> 8 & 255;
               this.var_2604 = this.var_1258 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1341));
            if(_loc5_ != this.var_1883)
            {
               this.var_1883 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_229);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_884));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_863));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_822));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1377);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1284);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1124 || _loc3_ != this.var_1539))
            {
               this.var_1124 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1308);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2607)
            {
               this.var_2607 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_152.length)
         {
            _loc5_ = this.var_152[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_76 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_395;
         if(this.var_395.length == 0)
         {
            _loc6_ = this.var_152;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_395.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_395.push(_loc12_);
                        this.var_663.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1257;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_548.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_152.length)
         {
            _loc3_ = this.var_152[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_548.maskCount)
         {
            _loc10_ = this.var_548.getMaskType(_loc8_);
            _loc11_ = this.var_548.getMaskLocation(_loc8_);
            _loc12_ = this.var_548.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_152.length)
               {
                  _loc3_ = this.var_152[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_264)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_152[_loc18_] as RoomPlane;
