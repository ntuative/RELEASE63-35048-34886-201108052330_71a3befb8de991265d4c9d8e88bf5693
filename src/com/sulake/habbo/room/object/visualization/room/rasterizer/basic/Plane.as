package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_1411:PlaneVisualization = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_425 != null)
         {
            ...
            {
               _loc1_ = this.var_425.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function clearCache() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_425.length)
         {
            _loc2_ = this.var_425.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(this.var_425.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc4_:PlaneVisualization = new PlaneVisualization(param1,param2,param3);
         this.var_425.add(String(param1),_loc4_);
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            this.var_1411 = this.var_425.getValue(String(this._sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            this.var_1411 = null;
