package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_678:String = "EffectsView";
       
      
      private var var_809:IGraphicAssetCollection = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_152 != null)
         {
            ...
            {
               _loc2_ = this.var_152.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_625.length)
            {
               _loc3_ = this.var_625.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_224.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_224.getValue(param1) as PlaneTexture;
      }
      ...
      {
         return this.var_152.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_152.getValue(param1) == null)
         {
            this.var_152.add(param1,param2);
            return true;
         }
         return false;
      }
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_809.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_625.getValue(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            this.var_625.add(_loc4_,_loc5_);
         }
         return _loc5_;
      }
