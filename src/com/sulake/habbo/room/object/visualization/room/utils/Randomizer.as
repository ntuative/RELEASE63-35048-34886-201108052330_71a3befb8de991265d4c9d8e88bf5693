package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2313:int = 16777216;
      ...
      private var var_2173:int = 16777216;
      
      private var var_3130:int = 69069;
      
      private var var_3129:int = 5;
      ...
      {
         var _loc1_:int = this.var_3130 * this.var_2174 + this.var_3129;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2173;
         this.var_2174 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2173 * param2);
      }
   }
}
