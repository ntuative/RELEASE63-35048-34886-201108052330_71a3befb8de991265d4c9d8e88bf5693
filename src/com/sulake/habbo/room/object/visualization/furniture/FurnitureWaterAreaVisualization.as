package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1515:String = "shore";
       
      
      private var var_1814:Boolean = true;
      ...
      {
         if(this.var_2439 == param1 && this.var_2440 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1515)
            {
               this.var_1815 = _loc2_;
               this.var_2439 = param1;
               this.var_2440 = direction;
               return this.var_1815;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1214.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1814 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_453.length)
         {
            if(this.var_453[_loc5_] == true)
            {
               this.var_1814 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_641[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_641[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_537 == 0 || this.var_642 == 0)
         {
            ...
            this.var_537 = _loc2_.getNumber(RoomObjectVariableEnum.const_311);
            this.var_642 = _loc2_.getNumber(RoomObjectVariableEnum.const_331);
         }
         this.var_453 = [];
         this.var_641 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_537 * 2 + this.var_642 * 2)
         {
            this.var_453.push(false);
            this.var_641.push(ShoreMaskCreatorUtility.const_85);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_81,getSize(param3),this.var_453,this.var_641,assetCollection);
      }
