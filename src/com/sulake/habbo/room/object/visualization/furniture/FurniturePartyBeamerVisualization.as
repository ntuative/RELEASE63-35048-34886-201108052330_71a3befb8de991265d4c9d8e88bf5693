package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1084:int = 15;
      
      private static const const_1085:int = 31;
      
      private static const const_1545:int = 2;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1254[param2];
         var _loc4_:int = this.var_1256[param2];
         var _loc5_:int = this.var_1253[param2];
         var _loc6_:Number = this.var_1255[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1084;
         }
         ...
         this.var_1254[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1255[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1254.push(Math.random() * _loc2_ * 1.5);
         this.var_1254.push(Math.random() * _loc2_ * 1.5);
         this.var_1256 = new Array();
         this.var_1256.push(1);
         this.var_1256.push(-1);
         this.var_1253 = new Array();
         this.var_1253.push(const_1545);
         this.var_1253.push(const_1546);
         this.var_1255 = new Array();
         this.var_1255.push(this.getRandomAmplitudeFactor());
         this.var_1255.push(this.getRandomAmplitudeFactor());
      }
