   ...
   public class FurnitureRoomBackgroundVisualization extends FurnitureRoomBrandingVisualization
   {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_897 != null)
         {
            ...
            _loc5_ = this.var_897[_loc4_];
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetX(param2,0) + var_1727;
            }
         }
         return super.getSpriteXOffset(param1,param2,param3) + var_1727;
      }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_897 != null)
         {
            ...
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetY(param2,0) + var_1728;
            }
         }
         return super.getSpriteYOffset(param1,param2,param3) + var_1728;
      }
