package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1747:String = "head";
      
      private static const const_730:int = 1;
      
      private static const const_1164:int = 1000;
      
      private static const const_1745:String = "pet_experience_bubble_png";
      
      private static const const_1746:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1148 = [];
         super();
         while(this.var_143.length < ANIMATION_INDEX_COUNT)
         {
            this.var_143.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_143.length)
            {
               _loc2_ = this.var_143[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1745) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_426 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_3044)
            {
               this.var_3044 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_145)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_304);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_177);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_304);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_177);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2197 = _loc3_.getNumber(RoomObjectVariableEnum.const_256) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            if(!isNaN(_loc8_))
            {
               this.var_2209 = _loc8_;
            }
            else
            {
               this.var_2209 = direction;
            }
            this.var_1612 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2361 = _loc3_.getNumber(RoomObjectVariableEnum.const_443);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_964);
            if(_loc9_ != this.var_2210)
            {
               this.var_2210 = _loc9_;
               this.var_3045 = this.var_2210.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_426 != null)
         {
            ...
            if(this.var_1612 > 0)
            {
               _loc2_ = param1 - this.var_1612;
               if(_loc2_ < const_1164)
               {
                  this.var_426.alpha = int(Math.sin(_loc2_ / const_1164 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_426.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_426.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_730;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_143.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1705 = false;
         var _loc1_:int = this.var_143.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_143[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_143.length)
         {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_143.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_143[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_3045);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_730)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_730))
            {
               if(param2 >= FurnitureVisualizationData.const_589.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_589[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2209);
         }
         return direction;
      }
      ...
      {
         if(this.var_1148[param1] == null)
         {
            if(this._animationData.getTag(var_101,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1747)
            {
               this.var_1148[param1] = true;
            }
            else
            {
               this.var_1148[param1] = false;
            }
         }
