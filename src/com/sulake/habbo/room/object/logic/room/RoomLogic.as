package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1824:int = 255;
      
      private var var_1494:uint = 16777215;
      
      private var var_1821:int = 255;
      
      private var var_1222:uint = 16777215;
      
      private var var_1822:int = 255;
      
      private var var_1221:int = 0;
      
      private var var_1823:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_618,RoomObjectMouseEvent.const_173];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_779,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1007,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_884,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_863,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_822,1);
         }
      }
         ...
         if(this.var_1493)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_779,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1308,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1221)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1824;
            if(_loc2_ - this.var_1221 >= this.var_1823)
            {
               _loc3_ = this.var_1222;
               _loc4_ = this.var_1822;
               this.var_1221 = 0;
            }
            else
            {
               _loc7_ = this.var_1494 >> 16 & 255;
               _loc8_ = this.var_1494 >> 8 & 255;
               _loc9_ = this.var_1494 & 255;
               _loc10_ = this.var_1222 >> 16 & 255;
               _loc11_ = this.var_1222 >> 8 & 255;
               _loc12_ = this.var_1222 & 255;
               _loc13_ = (_loc2_ - this.var_1221) / this.var_1823;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1821 + (this.var_1822 - this.var_1821) * _loc13_;
               this._color = _loc3_;
               this.var_1824 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1007,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_957:
               param2.setString(RoomObjectVariableEnum.const_220,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_769:
               param2.setString(RoomObjectVariableEnum.const_229,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_968:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_640:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_264)
               {
                  _loc5_ = "null";
               }
               this.var_548.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_961:
               _loc4_ = this.var_548.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_548.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1286,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1333:
               param2.setNumber(RoomObjectVariableEnum.const_884,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1251:
               param2.setNumber(RoomObjectVariableEnum.const_863,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_822,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_718:
               param2.setNumber(RoomObjectVariableEnum.const_1377,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1347:
               param2.setNumber(RoomObjectVariableEnum.const_1284,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_145:
               ...
               this.var_1493 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_160:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1341,int(param1.bgOnly));
         this.var_1494 = this._color;
         this.var_1821 = this.var_1824;
         this.var_1222 = _loc3_;
         this.var_1822 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_670,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1880,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_2044,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1792,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_670,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_314 || _loc12_ == RoomPlaneData.const_434)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
