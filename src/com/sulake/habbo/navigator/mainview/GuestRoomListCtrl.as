package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_615 = IScrollbarWindow(this.var_194.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_2037,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_206,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_142,null,0);
         this.refreshRoomName(param1,param2);
         this.var_1190.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_579.visible && this.var_2832)
         {
            return;
         }
      ...
      private function onMouseClick(param1:WindowEvent) : void
      {
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            {
               case RoomSettingsFlatInfo.const_142:
                  this._navigator.passwordInput.show(_loc4_,_loc5_);
                  return;
               case RoomSettingsFlatInfo.const_206:
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2831 - _loc2_.stageX);
         this.var_2831 = _loc2_.stageX;
         this.var_2832 = _loc3_ > 2;
      }
   }
}
