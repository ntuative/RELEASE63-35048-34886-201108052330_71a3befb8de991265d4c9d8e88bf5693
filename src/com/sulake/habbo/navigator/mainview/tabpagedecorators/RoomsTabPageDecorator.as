package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_162 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_421);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_813);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_421,"" + _loc3_);
         }
         if(this.var_162)
         {
            this._navigator.trackNavigationDataPoint(this.var_162.enumerateSelection()[this.var_162.selection],"category.view");
         }
      }
