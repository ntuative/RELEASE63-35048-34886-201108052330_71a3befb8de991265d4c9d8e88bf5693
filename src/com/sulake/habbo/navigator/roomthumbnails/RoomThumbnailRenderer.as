package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_528:int = 10;
      
      private static const const_1163:int = 32;
      
      private static const const_1744:int = 8;
      
      private static const const_1743:int = -16;
      
      private static const const_1742:int = 40;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_3031:Dictionary;
      
      private var var_1146:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_1146 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_3031 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1163 / 2);
         return new Point(param1 * const_1163 + _loc3_,param2 * const_1744);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_344,HabboWindowStyle.const_45,0 | (!!param3 ? HabboWindowParam.const_46 : HabboWindowParam.const_45),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1146.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_1146.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1146.getImage(ThumbnailEditorModel.const_64,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1701 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1701,this.var_1701.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_1146.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1743,_loc4_.y + const_1742 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_3031[param1]);
      }
   }
}
