package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1259:TextFieldManager;
      
      private var var_1026:TextFieldManager;
      
      private var var_1022:TextFieldManager;
      
      private var var_1024:TextFieldManager;
      
      private var var_1266:TextFieldManager;
      
      private var var_1267:ICheckBoxWindow;
      
      private var var_1265:ICheckBoxWindow;
      ...
      private var var_1023:IDropMenuWindow;
      ...
      {
         if(param1 != this.var_396 || this.var_1261 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1261 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_2060)
         {
            this.var_829.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2039)
         {
         ...
         {
            this.var_1259.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1799)
         {
            this.setTagError(this.var_1026,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1022,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2002)
         {
            this.setTagError(this.var_1026,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1022,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1790)
         {
            this.var_1024.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1259.clearErrors();
         this.var_1026.clearErrors();
         this.var_1022.clearErrors();
         this.var_1024.clearErrors();
         this.var_1266.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_516,this.onDoorModePasswordUnselect);
         ...
         this.var_1259 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1026 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1022 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1024 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1266 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1267 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1265 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1262 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_831 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1890 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1023 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1025 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2612 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1260 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1263 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1889 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1542 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_252 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1264 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1540 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1540.mouseThreshold = 0;
         this.var_1540.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1264.visible = false;
         if(!this.var_1541)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1889.visible = this.var_1541;
         this.populateForm();
         if(this.var_830)
         {
            this.var_1263.visible = true;
            this.var_1542.visible = true;
            this.refreshFlatControllers();
            this.var_1263.height = Util.getLowestPoint(this.var_1263) + 4;
         }
         else
         {
            this.var_1260.visible = true;
            this.var_1542.visible = true;
            this.var_2612.visible = this.var_1541;
            this.var_1260.height = Util.getLowestPoint(this.var_1260) + 4;
         }
         this.var_1540.text = !!this.var_830 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1260.name,this.var_1263.name,this.var_1542.name,this.var_1889.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1259.setText(_loc1_.description);
         this.var_1024.setText("");
         this.var_1266.setText("");
         ...
         {
            case RoomSettingsData.const_206:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_142);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_1026,_loc1_.tags[0]);
         this.setTag(this.var_1022,_loc1_.tags[1]);
         if(this.var_1267)
         {
            if(_loc1_.allowPets)
            {
               this.var_1267.select();
            }
            else
            {
               this.var_1267.unselect();
            }
         }
         if(this.var_1265)
         {
            ...
            {
               this.var_1265.select();
            }
            else
            {
               this.var_1265.unselect();
            }
         }
         if(this.var_1262)
         {
            ...
            {
               this.var_1262.select();
            }
            else
            {
               this.var_1262.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_831);
            this.disableWindow(this.var_1023);
            this.disableWindow(this.var_1025);
            this.disableWindow(this.var_1890);
         }
         else
         {
            this.enableWindow(this.var_831);
            this.enableWindow(this.var_1023);
            this.enableWindow(this.var_1025);
            this.enableWindow(this.var_1890);
         }
         if(this.var_831)
         {
            if(_loc1_.hideWalls)
         ...
         if(this.var_1023)
         {
            this.var_1023.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1025)
         {
            this.var_1025.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1259.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_206;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_142;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_505;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_142)
         {
            _loc8_ = this.var_1024.getText();
            _loc9_ = this.var_1266.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1024.clearErrors();
               this.var_1266.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1267.isSelected;
         _loc2_.allowFoodConsume = this.var_1265.isSelected;
         _loc2_.allowWalkThrough = this.var_1262.isSelected;
         _loc2_.hideWalls = this.var_831.isSelected;
         _loc2_.wallThickness = this.var_1023.selection - 2;
         _loc2_.floorThickness = this.var_1025.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1026,_loc2_.tags);
         this.addTag(this.var_1022,_loc2_.tags);
         this.clearErrors();
         this.var_1261 = _loc2_.roomId;
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_252.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_252.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_56.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_252.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_252.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_252.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_252.findChildByName("flat_controllers_footer"));
            if(this.var_56 != null && this.var_56.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_252,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_252.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_74,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
