package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onIssueInfo(param1:IssueInfoMessageEvent) : void
      {
         ...
         this.var_74.issueManager.playSound(_loc3_);
         this.var_74.issueManager.updateIssue(_loc3_);
      }
      ...
      private function onModeratorInit(param1:ModeratorInitMessageEvent) : void
      {
         ...
         {
            this.var_74.issueManager.updateIssue(_loc6_);
         }
         this.var_74.issueManager.updatePriorities();
         this.var_74.initMsg = _loc3_;
         this.var_74.startPanel.show();
      }
      ...
      private function onIssuePickFailed(param1:IssuePickFailedMessageEvent) : void
      {
         ...
         var pickedAlready:Boolean = this.var_74.issueManager.issuePickFailed(issues);
         if(pickedAlready)
         {
            if(retryEnabled)
            {
               ...
               {
                  alert = false;
                  this.var_74.issueManager.autoPick(retryEnabled,retryCount);
               }
            }
         }
         if(alert)
         {
            this.var_74.windowManager.alert("Error","Issue picking failed",0,function(param1:IAlertDialog, param2:WindowEvent):void
            {
               param1.dispose();
            });
         }
      ...
      private function onIssueDeleted(param1:IssueDeletedMessageEvent) : void
      {
         ...
         this.var_74.issueManager.removeIssue(_loc2_.issueId);
      }
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1269)
         {
      ...
      private function onRoomInfo(param1:ModeratorRoomInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1270)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.method_5,WindowTracker.const_1338,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_947,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_1303,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         var _loc7_:Array = this.var_1271.concat();
      ...
      private function onRoomVisits(param1:RoomVisitsEvent) : void
      {
         ...
         var _loc4_:Array = this.var_1268.concat();
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         {
            this.var_74.currentFlatId = _loc2_.guestRoomId;
            this.var_74.startPanel.guestRoomEntered(_loc2_);
         }
         else
         {
            this.var_74.currentFlatId = 0;
         }
         for each(_loc3_ in this.var_1033)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onPublicSpaceCastLibs(param1:PublicSpaceCastLibsEvent) : void
      {
         ...
         this.var_74.startPanel.publicSpaceEntered(_loc2_);
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         var _loc2_:* = null;
         this.var_74.currentFlatId = 0;
         this.var_74.startPanel.roomExited();
      ...
      private function onModeratorActionResult(param1:ModeratorActionResultMessageEvent) : void
      {
         ...
         if(_loc2_.success)
         {
            this.var_74.connection.send(new GetModeratorUserInfoMessageComposer(_loc2_.userId));
         }
         else
         {
            this.var_74.windowManager.alert("Alert","Moderation action failed",0,this.onAlertClose);
         }
      }
      ...
      public function removeRoomVisitsListener(param1:RoomVisitsCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_1268)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_1271)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
