package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1272:IDropMenuWindow;
      ...
      private var var_1034:OffenceCategoryData;
      
      private var var_1035:OffenceData;
      
      private var var_1273:IButtonWindow;
      
      private var var_1274:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1273 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1274 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1896;
         ...
         this.var_1272 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1272);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1034 != null;
         if(this.var_1035 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1035.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1034 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1034.offences,this.var_1273,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1274,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1932;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1543,this.var_549.text,this.var_1544));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1034 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1035 = this.var_1034.offences[_loc3_];
         this.var_549.text = this.var_1035.msg;
         this.var_655 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1543,this.var_549.text,this.var_1544));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1272.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1543,this.var_549.text,this.getBanLength(),this.var_1544));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1272.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1273.destroy();
            this.var_1273 = null;
         }
         if(this.var_1274 != null)
         {
            this.var_1274.destroy();
            this.var_1274 = null;
         }
         this.var_1272 = null;
         this.var_549 = null;
