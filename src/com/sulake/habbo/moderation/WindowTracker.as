package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1844:int = 1;
      
      public static const const_1836:int = 2;
      
      public static const const_1338:int = 3;
      
      public static const const_947:int = 4;
      
      public static const const_1303:int = 5;
      
      public static const const_1998:int = 6;
      
      public static const const_1932:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_2013:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2153[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2153[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
