package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_913:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2958 = param2.pickerUserId;
         this.var_2957 = param2.pickerUserName;
         this.var_1676 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1382 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1383;
         }
         if(this.var_913 == null || param1.timeStamp < this.var_913.timeStamp)
         {
            this.var_913 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1382 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1383;
            }
            if(this.var_913 == _loc2_)
            {
               this.var_913 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_913;
         if(_loc2_ == null)
         {
