package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1281:IDropMenuWindow;
      ...
      private var var_1680:ICheckBoxWindow;
      
      private var var_1679:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_396));
         Logger.log("BEGINNING TO SHOW: " + this.var_396);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_2013;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1281 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1281);
         this.var_1281.procedure = this.onSelectTemplate;
         this.var_1130 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1680 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1679 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_947,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_655 || this.var_549.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1130.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_2030,_loc2_,this.var_549.text,"",""));
         if(this.var_1680.isSelected || this.var_1679.isSelected || this.var_1130.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1680.isSelected,this.var_1679.isSelected,this.var_1130.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2036);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2006);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1281.selection];
         if(_loc3_ != null)
         {
            this.var_655 = false;
