package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1110:int = 60;
      
      private static const const_1111:int = 3600;
      
      private static const const_1112:int = 86400;
      
      private static const const_1113:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_1310 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_1110)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1111)
         {
            return Math.round(param1 / const_1110) + " mins ago";
         }
         if(param1 < 2 * const_1112)
         {
            return Math.round(param1 / const_1111) + " hours ago";
         }
         if(param1 < 2 * const_1113)
         {
            return Math.round(param1 / const_1112) + " days ago";
         }
         return Math.round(param1 / const_1113) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1309.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1309.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1303,this._data.userId),this._callerFrame,this.var_1310,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1310,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1544),this._callerFrame,this.var_1310,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1544),this._callerFrame,this.var_1310,false,true);
      }
