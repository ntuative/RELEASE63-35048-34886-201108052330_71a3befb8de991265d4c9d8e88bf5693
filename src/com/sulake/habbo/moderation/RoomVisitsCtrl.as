package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1947:int = 200;
      ...
      {
         this.var_851 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1998;
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1577)
         {
