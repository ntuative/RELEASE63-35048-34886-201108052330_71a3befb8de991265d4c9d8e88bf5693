package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_374:AdImageRequest;
      
      private var var_1182:BitmapData = null;
      
      private var var_1183:BitmapData = null;
      ...
      {
         this.var_304 = param2 as IHabboCommunicationManager;
         if(this.var_304 == null)
         {
            return;
         }
         this._connection = this.var_304.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2340 = this._config.getKey("interstitial.enabled","RoomWidgetChatSelectAvatarMessage") == "true";
         this.var_2341 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2342 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1750 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_242 != null && this.var_242.running)
         {
            this.var_242.reset();
            return false;
         }
         if(this.var_1181 == 0)
         {
            this.var_1181 = getTimer();
            return false;
         }
         if(this.var_1750 > 0 && this.var_1751 >= this.var_1750)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1181;
         if(_loc1_ > this.var_2341)
         {
            ++this.var_1751;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1465 = _loc2_.imageUrl;
         this.var_2339 = _loc2_.clickUrl;
         this.var_1181 = getTimer();
         if(this.var_1465 != "")
         {
            _loc3_ = this.var_1465;
            ...
            {
               this.var_242 = new Timer(this.var_2342,1);
               this.var_242.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_242.running)
            {
               this.var_242.reset();
            }
            this.var_242.start();
            _loc4_ = new URLRequest(this.var_1465);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_609,param1.bitmapData,this.var_2339));
            this.var_1181 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_622));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_374 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_374 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_374 = new AdImageRequest(this.var_374.roomId,this.var_374.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_374 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_672,this.var_374.roomId,this.var_374.roomCategory,_loc4_,_loc2_.assetName,this.var_374.clickURL,this.var_1182,this.var_1183));
            this.var_374 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1182 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1183 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_631.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_631.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_631.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_803,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_631.remove(_loc2_.assetName);
