package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1118:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1653:String = "sendAccessTokenToServer";
      
      private static const const_1654:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1653,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1654,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1118);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1118);
         }
      }
