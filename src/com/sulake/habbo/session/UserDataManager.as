package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1562:int = 1;
      
      private static const const_1563:int = 2;
      
      private static const const_2107:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1562);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_1043.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserBadges(param1:int, param2:Array) : void
      {
         ...
         this.var_1043.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1563);
      }
