package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_735:ProductDataParser;
      ...
      private var var_353:FurnitureDataParser;
      
      private var var_2140:UserTagManager;
      
      private var var_1119:BadgeImageManager;
      
      private var var_2139:HabboGroupInfoManager;
      
      private var var_1121:IgnoredUsersManager;
      ...
      private var var_1378:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3128 = [];
         this.var_2140 = new UserTagManager(events);
         this.var_2139 = new HabboGroupInfoManager(this,events);
         this.var_1121 = new IgnoredUsersManager(this);
         this.var_1378 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_353)
         {
            this.var_353.removeEventListener(FurnitureDataParser.const_140,this.onFurnitureReady);
            this.var_353.dispose();
            this.var_353 = null;
         }
         if(this.var_735)
         {
            this.var_735.removeEventListener(ProductDataParser.const_140,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1119 = new BadgeImageManager(assets,events,this._configuration,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2140.communication = this._communication;
         this.var_2139.communication = this._communication;
         this.var_1378.communication = this._communication;
         this.var_1121.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_353)
         {
            ...
            this.var_353 = new FurnitureDataParser(this.var_599,this._wallItems,this.var_598,this._localization);
            this.var_353.addEventListener(FurnitureDataParser.const_140,this.onFurnitureReady);
            if(this._configuration.keyExists("furnidata.load.url"))
            {
               _loc3_ = this._configuration.getKey("furnidata.load.url");
               this.var_353.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_353)
         {
            this.var_353.localization = this._localization;
            this.var_353.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2141 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2422 = _loc3_.respectTotal;
         this.var_1379 = _loc3_.respectLeft;
         this.var_911 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1006 = _loc3_.sex;
         this.var_1969 = _loc3_.realName;
         this.var_1121.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1006 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1006));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2949 = _loc2_.isOpen;
         this.var_2948 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2141 >= SecurityLevelEnum.const_1298;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2140.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1119.getBadgeImage(param1);
      }
      
      public function requestBadgeImage(param1:String) : BitmapData
      {
         return this.var_1119.getBadgeImage(param1,BadgeImageManager.const_1217,false);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1119.getBadgeImageWithInfo(param1);
      }
      
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(this._configuration.getKey("groupBadgeInfo.enabled") == "RoomWidgetChatSelectAvatarMessage")
         {
      ...
      {
         return this.var_2139.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1119.getBadgeImage(param1,BadgeImageManager.const_1406);
      }
      ...
      {
         return this.var_1121.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1121.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1121.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1379 < 1 || _loc2_ == null)
         {
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_911 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_911 = this.var_911 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_599.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_598.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1377.indexOf(param1) == -1)
         {
            this.var_1377.push(param1);
         }
         if(!this._configuration)
         {
            return false;
         ...
         if(this.var_735 == null)
         {
            ...
            this.var_735 = new ProductDataParser(_loc2_,this.var_1398);
            this.var_735.addEventListener(ProductDataParser.const_140,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_735.removeEventListener(ProductDataParser.const_140,this.onProductsReady);
         this.var_2142 = true;
         for each(_loc2_ in this.var_1377)
         {
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_599.getValues();
