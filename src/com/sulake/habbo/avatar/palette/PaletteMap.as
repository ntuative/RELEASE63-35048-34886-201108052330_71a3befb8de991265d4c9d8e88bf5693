package com.sulake.habbo.avatar.palette
{
   ...
   public class PaletteMap
   {
      ...
      {
         param1.paletteMap(param1,param1.rect,new Point(0,0),this._blank,this.var_720,this._blank,this._blank);
      }
      ...
      public function colorize(param1:ByteArray) : ByteArray
      {
         ...
         while(param1.bytesAvailable >= 4)
         {
            ...
            _loc7_ = uint(this.var_720[_loc5_] as uint);
      ...
      public function invert() : void
      {
         ...
         while(this.var_720.length > 0)
         {
            _loc1_.push(this.var_720.pop());
         }
         this.var_720 = _loc1_;
      }
   }
