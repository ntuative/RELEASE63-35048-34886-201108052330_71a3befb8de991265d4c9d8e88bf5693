package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorMessageHandler
   {
      ...
      private var var_26:HabboAvatarEditorManager;
      ...
      {
         if(param1 == null || !this.var_26)
         {
            return;
         }
         var _loc2_:HabboAvatarEditor = this.var_26.getEditor(AvatarEditorInstanceId.const_236);
         if(_loc2_)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.clubMemberLevel = this.var_26.sessionData.clubLevel;
            _loc2_.update();
         }
      }
   }
