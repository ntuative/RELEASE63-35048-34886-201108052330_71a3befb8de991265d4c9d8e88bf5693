package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_691:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_691 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_691.numGridItems > 0)
         {
            this.var_691.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_78 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_78.hotLooks)
         {
            ...
            this.var_691.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_691.getGridItemIndex(param2.parent);
