package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1655:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1656:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      
      private static const const_707:int = 2;
       
      
      private var var_2484:uint;
      
      private var var_571:HabboAvatarEditorManager;
      
      private var var_1085:IFigureData;
      ...
      private var var_1333:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_571 = param2;
         this.var_1085 = this.var_571.avatarRenderManager.getFigureData(AvatarType.const_131);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_570)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_703["null"] = new FigureData(this);
         this.var_703["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_703["null"];
         var _loc3_:FigureData = this.var_703["null"];
         _loc2_.loadAvatarData(const_1655,FigureData.const_89);
         _loc3_.loadAvatarData(const_1656,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_570 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_1027,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_54,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_299,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_906,new LegsModel(this));
         ...
         this.var_570.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
         this.var_570.add(AvatarEditorSideCategory.const_598,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc5_:FigureData = this.var_703[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1085.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1085.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_1027);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_570.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_703[this.var_1006];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1333.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_571.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2040;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_882 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_707)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1718.clone() as IWindowContainer,param1,_loc13_);
                     _loc4_[_loc17_].push(_loc18_);
                     _loc17_++;
                  }
                  if(param2 != FigureData.const_93)
                  {
                     _loc19_ = 0;
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_571.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_571.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_571.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1427.clone() as IWindowContainer,param1,null,null,false);
                  _loc7_.iconImage = _loc22_;
                  _loc3_.push(_loc7_);
               }
            }
            _loc16_ = param2 != FigureData.const_93;
            for each(_loc6_ in _loc8_.partSets)
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1914)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1427.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_571.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_570.getValue(AvatarEditorSideCategory.const_108);
      }
