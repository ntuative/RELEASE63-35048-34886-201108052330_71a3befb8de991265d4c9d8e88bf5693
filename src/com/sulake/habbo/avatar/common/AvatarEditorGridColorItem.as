package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1126:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_652.width,this.var_652.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_652,this.var_652.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1004.width,this.var_1004.height,true,0);
            _loc5_ = this.var_1004.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1126.colorTransform);
         ...
         if(_loc4_)
         {
            if(this.var_1126)
            {
               switch(this.var_1126.clubLevel)
               {
                  case HabboClubLevelEnum.const_53:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_33:
                     _loc4_.style = HabboIconType.const_911;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_761;
                     _loc4_.visible = true;
               }
            }
            else
