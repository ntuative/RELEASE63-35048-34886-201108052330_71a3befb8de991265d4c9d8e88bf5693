package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_622:IAvatarDataContainer;
      ...
      protected var var_1448:Boolean = false;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1172)
         {
            ...
            if(this.var_935)
            {
               for each(_loc2_ in this.var_935)
               {
                  _loc2_.dispose();
               }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_54 || param1 == AvatarSetType.const_42)
         {
            if(param1 == AvatarSetType.const_54 && this.isHeadTurnPreventedByAction())
            {
               param2 = this.var_102;
            }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_310.length == 1 && this.var_102 == this.var_2209)
         {
            return this.var_102 + this.var_609 + this.var_752 % 4;
         }
         if(this.var_310.length == 2)
         {
            for each(_loc1_ in this.var_310)
            {
               ...
               {
                  return this.var_102 + this.var_609 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_752 % 11;
                  return this.var_102 + "_" + this.var_2209 + this.var_609 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_3039 || param2 != this.var_3041 || param1 != this.var_3040)
         {
            this.var_3039 = param3;
            this.var_3041 = param2;
            this.var_3040 = param1;
            this.var_2207 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1448 || this.var_49 == null || (this.var_49.width != _loc5_.width || this.var_49.height != _loc5_.height))
         {
            if(this.var_49 != null && !this.var_1448)
            {
               this.var_49.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_318.definition.geometryType,this.var_102);
         this.var_49.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_752);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_752);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_365.push(new ActiveActionData(param1,param2,this.var_752));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_1088);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_310)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_609 = "";
         this.var_310 = this._structure.sortActions(this.var_365);
         if(this.var_310 == null)
         {
         ...
         {
            this.var_827 = this._structure.getCanvasOffsets(this.var_310,this._scale,this.var_102);
            for each(_loc4_ in this.var_310)
            {
               this.var_609 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_370)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1704 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_310)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_978 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_381 || _loc1_.actionType == AvatarAction.const_254 || _loc1_.actionType == AvatarAction.const_435)
               {
                  this.var_978 = true;
               }
            }
