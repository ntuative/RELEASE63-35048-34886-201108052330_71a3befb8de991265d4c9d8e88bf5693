   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_210,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_272,_windowManager,_assetLibrary);
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_309,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_78 && var_168 == "")
         {
            var_78.switchCategory(FigureData.const_210);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_eyewear":
                  ...
                  break;
               case "tab_masks":
                  this.switchCategory(FigureData.const_309);
            }
         }
