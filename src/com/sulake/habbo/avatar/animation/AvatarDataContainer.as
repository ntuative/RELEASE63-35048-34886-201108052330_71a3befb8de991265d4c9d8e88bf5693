package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2386:uint;
      
      private var var_2385:uint;
      ...
      {
         super();
         this.var_1780 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2386 = parseInt(_loc2_,16);
         this.var_2385 = parseInt(_loc3_,16);
         ...
         this.var_773 = new ColorTransform(this.var_2176,this.var_2177,this.var_2178,this._alphaMultiplier);
         this.var_1191 = this.generatePaletteMapForGrayscale(this.var_2385,this.var_2386);
      }
      ...
      {
         return this.var_1191.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1191.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1191.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1191.getValue("alphas") as Array;
      }
