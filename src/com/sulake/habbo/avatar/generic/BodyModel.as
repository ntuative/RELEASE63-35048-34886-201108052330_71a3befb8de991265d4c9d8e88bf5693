package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         super.init();
         initCategory(FigureData.const_93);
         _isInitialized = true;
         if(!_view)
         {
      ...
      override public function selectColor(param1:String, param2:int, param3:int) : void
      {
         ...
         this.updateSelectionsFromFigure(FigureData.const_93);
      }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_26.figureData.getPartSetId(FigureData.const_93);
         var _loc3_:Array = var_26.figureData.getColourIds(FigureData.const_93);
         var _loc4_:CategoryData = var_118[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         for each(_loc5_ in _loc4_.parts)
         {
            ...
            _loc5_.iconImage = _loc7_.getCroppedImage(AvatarSetType.const_54);
            _loc7_.dispose();
         }
      }
