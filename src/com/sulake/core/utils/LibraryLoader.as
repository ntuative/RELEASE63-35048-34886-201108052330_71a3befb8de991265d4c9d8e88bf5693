package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2076:uint = 2;
      ...
      public static const const_1287:Boolean = false;
      
      public static const const_1983:int = 2;
      
      private static var var_982:Array = new Array();
      
      private static var var_787:Array = new Array();
      ...
      protected var var_677:Class;
      
      protected var var_516:uint = 0;
      ...
      protected var var_3077:String = "";
      
      protected var var_2273:int;
      
      protected var var_1432:int;
      
      protected var var_1433:int;
      
      protected var var_3158:uint = 0;
      
      protected var var_3076:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1287)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_787[_loc2_] as LibraryLoader;
            ...
            while(var_787.length < const_1983 && false)
            {
               _loc1_ = var_982.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1161 ? uint(this.var_1432 - this.var_2273) : uint(getTimer() - this.var_2273);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_44.close();
            }
      ...
      {
         if(this.var_1162 && !_disposed)
         {
            this.var_1162 = false;
            if(!this.var_1161 && this.var_268)
            {
               this.var_1432 = -1;
               this.var_2273 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1161 && !_disposed && this.var_1433 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1908 - this.var_1433);
            if(this.var_3076)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_434 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_434))
               {
                  this.var_1432 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_516 = LibraryLoader.name_5;
         ...
         if(this.var_516 == LibraryLoader.const_2075)
         {
         ...
         if(this.var_516 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_677 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_677.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_434,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
