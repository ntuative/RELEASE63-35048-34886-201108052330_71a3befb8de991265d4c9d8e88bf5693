package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_164)
            {
               delete this.var_164[_loc1_];
            }
            this.var_164 = null;
         }
         this._length = 0;
      ...
      {
         if(this.var_164[param1] != null)
         {
            return false;
         }
         this.var_164[param1] = param2;
      ...
      {
         return this.var_164[param1];
      }
      
      public function remove(param1:*) : *
      {
         var _loc2_:Object = this.var_164[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_164[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_1309);
            }
         }
         this.var_164[param1] = param2;
