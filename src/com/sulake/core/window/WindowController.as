package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1279:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1432:String = "_COLORIZE";
      
      protected static const const_1433:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1090:Point = new Point();
      ...
      protected var var_765:Function;
      ...
      protected var var_438:WindowRectLimits;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_398 = new Rectangle();
         if(_loc12_ != null)
         {
            var_437 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_437.clone();
            var_10 = var_437.clone();
         ...
         if(_loc13_)
         {
            var_825 = _loc13_.blend;
            var_522 = _loc13_.var_3072;
            if(var_521 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_269 != _loc13_.color)
            {
      ...
      {
         return this.var_765 != null ? this.var_765 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      public function get limits() : IRectLimiter
      {
         if(!this.var_438)
         {
            this.var_438 = new WindowRectLimits(this);
         }
         return this.var_438;
      }
      ...
      {
         var_521 = param1;
         var_269 = !!var_521 ? uint(var_269 | var_619) : uint(var_269 & 16777215);
      ...
      {
         var_619 = param1 & 4278190080;
         var_269 = !!var_521 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_619 = param1 << 24;
         var_269 = !!var_521 ? uint(var_619 | var_269) : uint(16777215 & var_269);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
      }
      
      public function set blend(param1:Number) : void
      {
         var_825 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_10,WindowRedrawFlag.const_1387);
      }
      ...
      {
         var_522 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_10,WindowRedrawFlag.const_830);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_91)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1433) == -1)
               {
                  _loc4_.style = var_91;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_398 = this._parent.rectangle.clone();
               var_68.x = var_10.x;
               var_68.y = var_10.y;
               var_68.width = var_10.width;
               var_68.height = var_10.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_529,this,this._parent);
            ...
            else
            {
               this.var_398.x = 0;
               this.var_398.y = 0;
               this.var_398.width = 0;
               this.var_398.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1968,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_91,var_20,_context,var_10,null,this.var_765,this.properties,var_956.concat(),_id) as WindowController;
         _loc2_.var_522 = var_522;
         _loc2_.var_189 = this.var_189;
         _loc2_._debug = this._debug;
         _loc2_.var_398 = this.var_398.clone();
         _loc2_.var_10 = var_10.clone();
         _loc2_.var_437 = var_437.clone();
         _loc2_.var_68 = var_68.clone();
         _loc2_.var_166 = !!var_166 ? var_166.clone() : null;
         _loc2_.var_165 = !!var_165 ? var_165.clone() : null;
         _loc2_.var_438 = !!this.var_438 ? this.var_438.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_269 = var_269;
         _loc2_.var_619 = var_619;
         _loc2_.var_763 = var_763;
         _loc2_.var_321 = var_321;
         _loc2_.var_825 = var_825;
         _loc2_.var_20 = var_20;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_18;
         _loc2_.background = var_521;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2622 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(this.var_438)
         {
            param4 = Math.max(this.var_438.minHeight,param4);
            param4 = Math.min(this.var_438.maxHeight,param4);
            param3 = Math.max(this.var_438.minWidth,param3);
            param3 = Math.min(this.var_438.maxWidth,param3);
         }
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_626)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_604)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_614)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1367,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_415,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_165 != null)
         {
            param4.x = var_165.x;
            param4.y = var_165.y;
            param4.width = var_165.width;
            param4.height = var_165.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_165.x = param3.x;
            var_165.y = param3.y;
            var_165.width = param3.width;
            var_165.height = param3.height;
         }
         if(param2 != null)
         {
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_948))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1328;
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_353))
                        {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_380:
                  return false;
            }
         }
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_671,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_218,WindowParam.const_109))
                     {
                     ...
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_605))
                        {
                        ...
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_181,this._parent,this);
               ...
               case WindowEvent.const_415:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1216);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1823,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                  ...
                  break;
               case WindowEvent.const_675:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1391,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_529:
                  ...
                  _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
                  break;
               case WindowEvent.const_671:
                  this._parent.getRegionProperties(null,this.var_398);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_533:
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_522);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_522);
      }
         ...
         if(this.var_189 && var_522 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_10.width && param1.y <= var_10.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1090,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1090,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_91 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1433) == -1)
               {
                  _loc6_.style = var_91;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_146,WindowParam.const_109);
         var _loc2_:* = !testParamFlag(WindowParam.const_151,WindowParam.const_115);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_10.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_398.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_433)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               else if(_loc5_ == WindowParam.const_218)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_398.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_273)
               {
      ...
      {
         if(_state == WindowState.const_667)
         {
            return true;
         }
         _state = WindowState.const_667;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1804,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2025,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_2043,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1847,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_69,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1826,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1997,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1768,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1993,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_675,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2050,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_585,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_69,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1894,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_69,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1885,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1003,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_807,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_237,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1992,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_330,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1853,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1280 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_533,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1280 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_533,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_413,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
