package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2281:Boolean = false;
      
      protected var var_620:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_769:Number = -1.0;
      
      protected var var_768:Number = -1.0;
      
      protected var var_1165:Boolean = true;
      
      protected var var_523:Boolean = false;
      
      protected var var_1435:Boolean = false;
      
      protected var var_2280:int = 0;
      
      protected var var_2282:int = 0;
      
      protected var var_1436:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_124 = 0;
         this.var_107 = 0;
         this._horizontal = param2 == WindowType.const_398;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_189 = var_521 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_440,WindowStyle.const_103,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_181,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_219,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1435;
      }
      ...
      {
         return new Rectangle(this.var_766 * this.maxScrollH,this.var_767 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_766 = param1;
            this._container.x = -this.var_766 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            if(_events)
            {
               _loc2_ = WindowEvent.allocate(WindowEvent.const_577,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_767 = param1;
            this._container.y = -this.var_767 * this.maxScrollV;
            if(_events)
            {
               _loc2_ = WindowEvent.allocate(WindowEvent.const_577,this,null);
               _events.dispatchEvent(_loc2_);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_605,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_569,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_181,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2280 = _loc3_;
               this.var_2282 = _loc4_;
               this.var_1436 = 0;
               this.var_1437 = 0;
               this.var_1434 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_200:
               if(this.var_1434)
               {
                  this.var_1436 = this.var_2280 - _loc3_;
                  this.var_1437 = this.var_2282 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1436 != 0 && this.var_124 != 0)
                     {
                        this.scrollH += this.var_1436 / this.var_124;
                     }
                  }
                  else if(this.var_1437 != 0 && this.var_107 != 0)
                  {
                     this.scrollV += this.var_1437 / this.var_107;
                  }
                  this.var_2280 = _loc3_;
                  this.var_2282 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_249:
               if(this.var_1434)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1436,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1165 && !this.var_620 && this._container)
         {
            this.var_620 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_764)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_424,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1178);
         }
         if(this.var_1165 != PropertyDefaults.const_1413)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_790,this.var_1165,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1915);
         }
         if(this.var_523 != PropertyDefaults.const_1191)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_972,this.var_523,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1783);
         }
         if(this.var_1435 != PropertyDefaults.const_1238)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_909,this.var_1435,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1879);
         }
         if(this.var_769 != PropertyDefaults.const_1207)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_849,this.var_769,PropertyStruct.const_136,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1888);
         }
         if(this.var_768 != PropertyDefaults.const_1317)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_883,this.var_768,PropertyStruct.const_136,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1956);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_972:
                  ...
                  break;
               case PropertyDefaults.const_909:
                  this.resizeOnItemUpdate = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_790:
                  this.var_1165 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_849:
                  this.var_769 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_883:
                  this.var_768 = _loc2_.value as Number;
                  break;
            }
         }
