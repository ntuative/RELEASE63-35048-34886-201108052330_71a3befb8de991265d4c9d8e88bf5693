package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_663)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_888:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_663)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_888,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1809);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1336)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_885,param1.toolTipDelay,PropertyStruct.const_298,true));
         }
         else
         {
      ...
      {
         this.var_1431 = param1 == null ? "null" : param1;
      }
