package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1208:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_450)
         {
            ...
            this.var_450.removeEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            this.var_450 = null;
         }
         if(this.var_1208)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1208)
         {
            this.var_1208 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_450)
         {
            ...
            if(this.var_450)
            {
               ...
               this.var_450.addEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            }
         }
         return this.var_450;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_237)
         {
            this.hideScrollBar();
         }
      }
