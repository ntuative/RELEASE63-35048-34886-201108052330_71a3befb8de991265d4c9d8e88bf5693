package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1431:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_950:Number;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_443,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_443 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_443,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1030 ? true : null;
         }
      ...
      {
         this.var_950 = param1;
         this._field.scrollH = this.var_950 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_950 * this.maxScrollH,this.var_615 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_965,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1268));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1290 ? new PropertyStruct(PropertyDefaults.const_897,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1324) : PropertyDefaults.const_2023);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_298,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1375 ? new PropertyStruct(PropertyDefaults.const_1351,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1229) : PropertyDefaults.const_1953);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_910) ? new PropertyStruct(PropertyDefaults.const_458,this._field.textColor,PropertyStruct.const_159,true) : PropertyDefaults.const_1202);
         ...
         _loc1_.push(this.var_43.left != PropertyDefaults.const_837 ? new PropertyStruct(PropertyDefaults.const_268,this.var_43.left,PropertyStruct.const_39,true) : PropertyDefaults.const_838);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_875 ? new PropertyStruct(PropertyDefaults.const_302,this.var_43.top,PropertyStruct.const_39,true) : PropertyDefaults.const_967);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_992 ? new PropertyStruct(PropertyDefaults.const_277,this.var_43.right,PropertyStruct.const_39,true) : PropertyDefaults.const_832);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_836 ? new PropertyStruct(PropertyDefaults.const_282,this.var_43.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_1008);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1193 ? new PropertyStruct(PropertyDefaults.const_1002,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1802);
