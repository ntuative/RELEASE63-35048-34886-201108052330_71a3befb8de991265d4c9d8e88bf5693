package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1080:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_873:String;
      
      private var var_1326:String = null;
      
      private var var_2003:StyleSheet = null;
      ...
      {
         this.var_873 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1326 == param2)
         {
            return;
         }
         param1.var_1326 = param2;
         param1.var_2003 = null;
         if(param1.var_1326 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1326);
            param1.var_2003 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_962.indexOf(param1) > -1)
         {
            this.var_873 = param1;
         }
      }
      ...
      {
         return this.var_873 == LinkTarget.const_30 ? defaultLinkTarget : this.var_873;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_2003;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1397)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_873 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_775,this.var_873,PropertyStruct.const_52,true,PropertyDefaults.const_962));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1937);
         }
         return _loc1_;
      }
