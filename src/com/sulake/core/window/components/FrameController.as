package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1548:String = "_TITLE";
      
      private static const const_1550:String = "_HEADER";
      
      private static const const_1549:String = "_CONTENT";
      
      private static const const_1547:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1548) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1538 = findChildByTag(const_1550) as IHeaderWindow;
            if(!this.var_1538)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1549) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1547) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1161 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_353);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_296);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_305);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_296,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_296,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_305,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_305,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_336,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,_loc3_.left,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,_loc3_.top,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         return _loc1_;
      }
