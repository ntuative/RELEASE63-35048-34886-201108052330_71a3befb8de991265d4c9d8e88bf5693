package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1720:uint = 500;
      
      protected var var_1431:String = "";
      
      protected var var_1438:Boolean = false;
      
      protected var var_886:Boolean = false;
      ...
      {
         this.var_1431 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_886 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_457,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_345,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_900,false,PropertyStruct.const_38,true) : PropertyDefaults.const_2020);
         _loc1_.push(this.var_1438 != PropertyDefaults.const_1279 ? new PropertyStruct(PropertyDefaults.const_928,this.var_1438,PropertyStruct.const_38,true) : PropertyDefaults.const_2047);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1196 ? new PropertyStruct(PropertyDefaults.const_851,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1912);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1282 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_2040);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_928:
                  this.var_1438 = _loc2_.value as Boolean;
                  if(this.var_1438)
                  {
               ...
               case PropertyDefaults.const_900:
                  ...
                  break;
               case PropertyDefaults.const_1272:
