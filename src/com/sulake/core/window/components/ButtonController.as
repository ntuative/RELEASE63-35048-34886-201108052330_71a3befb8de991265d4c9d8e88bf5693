package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1438:Number = 0.5;
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_209:
                  try
                  {
                     getChildByName(const_468).blend = getChildByName(const_468).blend + const_1438;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               case WindowTouchEvent.const_812:
                  type = "null";
                  break;
               case WindowTouchEvent.const_1256:
                  type = "null";
                  break;
               case WindowTouchEvent.const_916:
                  type = "null";
            }
