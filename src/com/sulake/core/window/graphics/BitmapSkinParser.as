package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_102:String = "EffectsView";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_361 = SkinLayoutEntity.const_580;
                  break;
               case "move":
                  _loc5_.var_361 = SkinLayoutEntity.const_337;
                  break;
               case "strech":
                  _loc5_.var_361 = SkinLayoutEntity.const_584;
                  break;
               case "tiled":
                  _loc5_.var_361 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_361 = SkinLayoutEntity.const_518;
            }
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_337;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_584;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_518;
            }
         }
