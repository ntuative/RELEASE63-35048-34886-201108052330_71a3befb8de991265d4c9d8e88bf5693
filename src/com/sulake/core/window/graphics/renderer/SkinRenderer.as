package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_436:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_618)
            {
               ISkinLayout(this.var_618[_loc1_]).dispose();
               delete this.var_618[_loc1_];
            }
            this.var_618 = null;
            this.var_519 = null;
            for(_loc1_ in this.var_436)
            {
               ISkinTemplate(this.var_436[_loc1_]).dispose();
               delete this.var_436[_loc1_];
            }
            this.var_436 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_436[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_618[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_436[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_519)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_519[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_618[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_436[param1.name];
         }
         return param1;
      }
   }
