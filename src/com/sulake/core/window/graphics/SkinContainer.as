package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1081:uint = 8;
      
      private static const const_1541:String = "skin";
      
      private static const const_1536:String = "bitmap";
      
      private static const const_1538:String = "fill";
      
      private static const const_1537:String = "text";
      
      private static const const_1540:String = "label";
      
      private static const const_1539:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "RoomsWithHighestScoreSearchMessageComposer";
      
      protected static var var_368:Array;
      ...
      private var var_1014:Dictionary;
      
      private var var_460:Dictionary;
      
      private var var_1868:Dictionary;
      
      private var var_2575:Dictionary;
      
      private var var_2577:Dictionary;
      
      private var var_2576:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1014 = new Dictionary();
         this.var_1868 = new Dictionary();
         this.var_2575 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1868,this.var_2575);
         this.var_2577 = new Dictionary();
         this.var_2576 = new Dictionary();
         StateCodeTable.fillTables(this.var_2577,this.var_2576);
         this.var_460 = new Dictionary();
         this.var_460[const_1541] = BitmapSkinRenderer;
         this.var_460[const_1536] = BitmapDataRenderer;
         this.var_460[const_1538] = FillSkinRenderer;
         this.var_460[const_1537] = TextSkinRenderer;
         this.var_460[const_1540] = LabelRenderer;
         this.var_460[const_1539] = ShapeSkinRenderer;
         this.var_460[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_460[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_368 == null)
         {
            var_368 = new Array();
            var_368.push(WindowState.const_69);
            var_368.push(WindowState.const_87);
            var_368.push(WindowState.const_98);
            var_368.push(WindowState.const_56);
            var_368.push(WindowState.const_94);
            var_368.push(WindowState.const_88);
            var_368.push(WindowState.const_92);
            var_368.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3072 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1868[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1013[param1] == null)
         {
            this.var_1013[param1] = new Array(const_1081);
         }
         this.var_1013[param1][param2] = param3;
         if(this.var_1014[param1] == null)
         {
            this.var_1014[param1] = new Array(const_1081);
         }
         this.var_1014[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1013[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1014[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)
