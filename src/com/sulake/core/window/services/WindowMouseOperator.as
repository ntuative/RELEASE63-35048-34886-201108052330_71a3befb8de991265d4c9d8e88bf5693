package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_764:Point;
      
      protected var var_1461:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_764);
         this._window.offset(this.var_764.x - this._offset.x,this.var_764.y - this._offset.y);
      }
