package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_150:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_150 = param1.stage;
         this.var_150.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_150.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_150.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_150.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_150.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_150.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_150.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_150.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_150 = null;
            this._disposed = true;
            var_34 = null;
         }
