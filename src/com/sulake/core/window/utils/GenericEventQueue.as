package com.sulake.core.window.utils
{
   ...
   public class GenericEventQueue implements IEventQueue, IDisposable
   {
      ...
      {
         var _loc1_:* = null;
         if(this._index < this.var_525.length)
         {
            _loc1_ = this.var_525[this._index];
            ++this._index;
         }
         return _loc1_;
      }
      ...
      {
         this.var_525.splice(this._index - 1,1);
         if(this._index > 0)
         {
            --this._index;
         }
      ...
      {
         this.var_525.splice(0,this.var_525.length);
         this._index = 0;
      }
      
      protected function eventListener(param1:Event) : void
      {
         this.var_525.push(param1);
      }
   }
}
