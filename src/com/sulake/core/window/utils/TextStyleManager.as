package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_96:Map;
      
      private static var var_575:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_709:String = "{";
      
      private static const const_710:String = "}";
      
      private static const const_1658:String = "/*";
      
      private static const const_1659:String = "*/";
      ...
      private static function init() : void
      {
         ...
         var_96[_loc1_.name] = _loc1_;
         var_575.push(_loc1_.name);
         _loc1_ = new TextStyle();
         _loc1_.name = ITALIC;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      {
         return var_96.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_96.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_96[param1] = param2;
         if(_loc3_)
         {
            var_575.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_96[const_224],var_96[ITALIC],var_96[BOLD]];
            var_96.reset();
            var_96[const_224] = _loc5_[0];
            var_96[ITALIC] = _loc5_[1];
            var_96[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_96[_loc4_.name] = _loc4_;
            if(var_575.indexOf(_loc4_.name) == -1)
            {
               var_575.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_96.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_96.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_710);
         if(countSubStrings(param1,const_709) != countSubStrings(param1,const_710))
         {
            throw new Error("Mismatching amount of \"" + const_709 + "\" versus \"" + const_710 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1658) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1659) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_709)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
