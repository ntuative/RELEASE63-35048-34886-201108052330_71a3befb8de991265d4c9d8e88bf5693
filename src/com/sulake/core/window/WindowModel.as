package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_437:Rectangle;
      ...
      protected var var_521:Boolean = false;
      
      protected var var_269:uint = 16777215;
      
      protected var var_619:uint;
      
      protected var var_522:uint = 10;
      
      protected var var_763:Boolean = true;
      
      protected var var_321:Boolean = true;
      
      protected var var_825:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_91 = param4;
         this.var_956 = param8 == null ? [] : param8;
         this._context = param6;
         this.var_10 = param7.clone();
         this.var_437 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_10 = null;
            this._context = null;
            this._state = WindowState.const_667;
            this.var_956 = null;
         }
      }
      ...
      {
         return this.var_437.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_437.height;
      }
