package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1376:String = "AssetLibraryReady";
      
      public static const const_778:String = "AssetLibraryLoaded";
      
      public static const const_1936:String = "AssetLibraryUnloaded";
      
      public static const const_1875:String = "AssetLibraryLoadError";
      
      private static const const_703:String = "name";
      
      private static const const_1101:String = "asset";
      
      private static const const_1100:String = "param";
      ...
      private static var var_1942:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_558:uint = 0;
      
      private static var var_1057:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_558;
         this.var_470 = new Dictionary(false);
         this.var_559 = new Dictionary(false);
         this.var_1056 = new Dictionary(false);
         this.var_177 = new Dictionary(false);
         var_1057.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_676 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1102);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1101);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1100);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_676 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1057.splice(var_1057.indexOf(this),1);
            --var_558;
            this.var_559 = null;
            this.var_1056 = null;
            this.var_177 = null;
      ...
      {
         if(this.var_676 == param1.url && this.var_1058)
         {
            if(!this.var_1059 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_677);
            }
            this.var_1059 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1376));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_559[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_559[_loc1_];
         }
         for(_loc1_ in this.var_177)
         {
            delete this.var_177[_loc1_];
         }
         for(_loc1_ in this.var_1056)
         {
            delete this.var_1056[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1058 = false;
         this.var_676 = null;
         dispatchEvent(new Event(AssetLibrary.const_1936));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1056[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_559[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1225,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1310,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1340,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1408,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_559[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_559[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_177[struct.assetName] == null)
                  {
                     ++this.var_472;
                     this.var_471.push(struct.assetName);
                  }
                  this.var_177[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_559[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_177[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_177)
         {
            _loc3_ = this.var_177[_loc2_];
      ...
      {
         return this.var_177[param1] != null || (this.var_677 != null ? this.var_677[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_177[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_177[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1942.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_470.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_470[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_470[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_470)
         {
            _loc3_ = AssetTypeDeclaration(this.var_470[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_470)
         {
            _loc4_ = AssetTypeDeclaration(this.var_470[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_677 = _loc2_.resource;
         this.var_676 = _loc2_.url;
         if(this.var_1059)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_677);
         }
         this.var_1058 = true;
         dispatchEvent(new Event(AssetLibrary.const_778));
         dispatchEvent(new Event(AssetLibrary.const_1376));
         if(this.var_1059)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1875));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1102);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1101);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_703) && _loc3_.attribute(const_703).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_676 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_677[param1]);
                     _loc6_ = _loc3_.child(const_1100);
