package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1169 = new LoaderContext();
         this.var_1169.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1169);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_364 = 0;
         this.var_44.load(param1,this.var_1169);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_364 < var_3082)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1166 + (this.var_1166.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_364),this.var_1169);
               return true;
            }
         }
         return false;
