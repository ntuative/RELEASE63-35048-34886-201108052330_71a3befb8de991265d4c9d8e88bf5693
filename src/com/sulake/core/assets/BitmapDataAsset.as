package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is Class)
         {
            _loc1_ = new this.var_119() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_119() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         if(this.var_119 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_119).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_119 is BitmapData)
         {
            this._bitmap = this.var_119 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_119)._bitmap;
            this._offset = BitmapDataAsset(this.var_119)._offset;
            this.var_1466 = BitmapDataAsset(this.var_119).var_1466;
            this.var_1467 = BitmapDataAsset(this.var_119).var_1467;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
