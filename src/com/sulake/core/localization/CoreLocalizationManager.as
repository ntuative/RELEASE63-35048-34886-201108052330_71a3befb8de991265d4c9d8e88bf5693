package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_966[param1];
         if(_loc4_ == null)
         {
            _loc4_ = new LocalizationDefinition(param1,param2,param3);
            this.var_966[param1] = _loc4_;
         }
      }
      
      public function activateLocalization(param1:String) : Boolean
      {
         var _loc2_:LocalizationDefinition = this.var_966[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_966[param1] as ILocalizationDefinition;
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_184));
         }
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_1946);
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1767);
         }
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_76)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1767);
            }
         }
      }
   }
