package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private var var_1452:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1215,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_22);
            Habbo.method_1("Failed to prepare the core: " + error.message,Core.const_1215,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1452 = HabboTracking.getInstance();
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.method_1("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_227,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.method_1("Download external configuration document is null!",Core.const_227,null);
         }
         if(this.var_25)
         {
         ...
         {
            Habbo.method_1("Core vanished while downloading config document!",Core.const_227,null);
         }
      }
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1452 && !this.var_1452.disposed)
                  {
                     this.var_1452.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
